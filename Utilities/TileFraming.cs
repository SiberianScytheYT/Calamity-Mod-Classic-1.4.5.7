...
namespace CalRD
{
    public static class TileFraming
    {
        ...
        internal static void PlantFrame(int x, int y)
        {
            ...
            else if (checkType == ModContent.GetInstance<CalRD>().Find<ModTile>("AstralGrass").Type)
            {
                ...
                plantType = ModContent.GetInstance<CalRD>().Find<ModTile>(isShortPlant ? "AstralShortPlants" : "AstralTallPlants").Type;
            }
        ...
        internal static void VineFrame(int x, int y)
        {
            ...
            int northType = north == null ? myType : (!north.HasTile || north.BottomSlope) ? -1 : north.TileType;
