...
namespace CalRD.NPCs.SupremeCalamitas
{
    public class SCalWormBody : ModNPC
    {
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
		{
			...
			Texture2D texture2D15 = NPC.localAI[3] == 1f ? ModContent.Request<Texture2D>("CalRD/NPCs/SupremeCalamitas/SCalWormBodyAlt").Value : TextureAssets.Npc[NPC.type].Value;
			...
			if (NPC.localAI[3] == 1f)
			{
				texture2D15 = ModContent.Request<Texture2D>("CalRD/NPCs/SupremeCalamitas/SCalWormBodyAltGlow").Value;
