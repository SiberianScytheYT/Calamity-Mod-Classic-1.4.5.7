    ...
    public class PerforatorHeadMedium : ModNPC
    {
        public override void SetStaticDefaults()
        {
            ...
            NPCID.Sets.NPCBestiaryDrawModifiers value = new NPCID.Sets.NPCBestiaryDrawModifiers()
            {
	            Scale = 0.7f,
	            PortraitScale = 0.7f,
	            CustomTexturePath = "CalRD/ExtraTextures/Bestiary/PerforatorMedium_Bestiary",
		...
		public override void AI()
		{
			...
			if (Main.netMode != NetmodeID.MultiplayerClient)
			{
				if (NPC.ai[0] == 0f)
				{
					...
					NPC.ai[0] = NPC.NewNPC(NPC.GetSource_FromThis(), (int)(NPC.position.X + (NPC.width / 2)), (int)(NPC.position.Y + NPC.height), ModContent.NPCType<PerforatorBodyMedium>(), NPC.whoAmI, 0f, 0f, 0f, 0f, 255);
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
		{
			...
			texture2D15 = ModContent.Request<Texture2D>("CalRD/NPCs/Perforator/PerforatorHeadMediumGlow").Value;
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if (NPC.life <= 0)
            {
	            if (Main.netMode != NetmodeID.Server)
	            {
		            ...
		            Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity, Mod.Find<ModGore>("MediumPerf").Type, 1f);
        ...
        {
			DropHelper.DropItem(NPC.GetSource_FromThis(), NPC, ModContent.ItemType<BloodSample>(), 3, 7);
			DropHelper.DropItem(NPC.GetSource_FromThis(), NPC, ItemID.CrimtaneBar, 2, 4);
			DropHelper.DropItem(NPC.GetSource_FromThis(), NPC, ItemID.Vertebrae, 2, 3);
        }
