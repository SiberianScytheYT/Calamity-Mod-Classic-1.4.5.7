    ...
    public class CalamitasRun : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
	        ...
	        bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] 
	        {
		        ...
		        new FlavorTextBestiaryInfoElement("One of the clone's creations, and a recreation of the Witch's brother Cataclysm. It possesses no will of its own.")
	        });
        }
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
		{
			...
			texture2D15 = ModContent.Request<Texture2D>("CalRD/NPCs/Calamitas/CalamitasRunGlow").Value;
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if (NPC.life <= 0)
            {
	            ...
	            {
		            Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity, Mod.Find<ModGore>("Cataclysm").Type, 1f);
		            Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity, Mod.Find<ModGore>("Cataclysm2").Type, 1f);
		            Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity, Mod.Find<ModGore>("Cataclysm3").Type, 1f);
		            Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity, Mod.Find<ModGore>("Cataclysm4").Type, 1f);
		            Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity, Mod.Find<ModGore>("Cataclysm5").Type, 1f);
