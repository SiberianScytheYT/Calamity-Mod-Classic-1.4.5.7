	...
	public class RavagerClawRight : ModNPC
    {
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            else
            {
                ...
                {
                    Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity, Mod.Find<ModGore>("ScavengerClawRight").Type, 1f);
                    Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity, Mod.Find<ModGore>("ScavengerClawRight2").Type, 1f);
                }
            }
        }
    }
