    ...
    public class PhantomDebris : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
	        bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
	        {
		        ...
		        new FlavorTextBestiaryInfoElement("We're not doing this again.")
	        });
        }

        public override void SetDefaults()
        {
            NPC.damage = NPC.downedMoonlord ? 60 : 30;
            NPC.width = 44;
            NPC.height = 22;
            NPC.defense = 20;
			NPC.DR_NERD(0.1f);
        ...
        public override void AI()
        {
			...
			float num65 = 1.2f + ((Main.player[NPC.target].Center - NPC.Center).Length() * 0.005f);
			float num66 = 0.12f + ((Main.player[NPC.target].Center - NPC.Center).Length() * 0.0005f);
