...
namespace CalRD.NPCs.NormalNPCs
{
    public class Eidolist : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            NPC.DeathSound = new SoundStyle("CalRD/Sounds/NPCKilled/EidolistDeath");
        ...
        public override void AI()
        {
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient && NPC.localAI[0] >= 300f)
            {
                ...
                if (Collision.CanHit(NPC.position, NPC.width, NPC.height, Main.player[NPC.target].position, Main.player[NPC.target].width, Main.player[NPC.target].height))
                {
                    ...
                    {
                        Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.Center, targetVec, ProjectileID.CultistBossLightningOrb, damage, 0f, Main.myPlayer, 0f, 0f);
                    }
                    else
                    {
                        ...
                        for (int n = 0; n < 1; n++)
                        {
                            ...
                            Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.Center, vector4, ProjectileID.CultistBossIceMist, damage, 0f, Main.myPlayer, 0f, 1f);
                        }
                    }
                }
            }
