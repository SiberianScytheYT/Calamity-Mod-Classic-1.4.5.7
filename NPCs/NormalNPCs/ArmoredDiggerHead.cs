...
namespace CalRD.NPCs.NormalNPCs
{
    public class ArmoredDiggerHead : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            {
                CustomTexturePath = "CalRD/ExtraTextures/Bestiary/ArmoredDigger_Bestiary",
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient)
            {
                if (!TailSpawned)
                {
                    ...
                    for (int j = 0; j <= num3; j++)
                    {
                        ...
                        int num5 = NPC.NewNPC(NPC.GetSource_FromThis(), (int)(NPC.position.X + (float)(NPC.width / 2)), (int)(NPC.position.Y + (float)NPC.height), num4, NPC.whoAmI, 0f, 0f, 0f, 0f, 255);
