    ...
    public class Cnidrion : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("Enigmatic creatures from the desert that store massive amounts of water within their bodies... is there's something more to them?")
            });
        }
        ...
        public override void AI()
        {
            ...
            else if (NPC.ai[0] == 1f)
            {
                ...
                if (NPC.ai[1] % 30f == 0f)
                {
                    ...
                    Projectile.NewProjectile(NPC.GetSource_FromThis(), vector18.X, vector18.Y, num829, num830, ModContent.ProjectileType<HorsWaterBlast>(), expertMode ? 8 : 11, 0f, Main.myPlayer, 0f, 0f);
                }
                if (NPC.ai[1] >= 120f)
                {
                    NPC.ai[1] = 0f;
            ...
            else if (NPC.ai[0] == 2f)
            {
                ...
                if (NPC.ai[1] > 60f && NPC.ai[1] < 240f && NPC.ai[1] % 16f == 0f)
                {
                    ...
                    Projectile.NewProjectile(NPC.GetSource_FromThis(), vector18.X, vector18.Y, num829, num830, ModContent.ProjectileType<HorsWaterBlast>(), expertMode ? 9 : 12, 0f, Main.myPlayer, 0f, 0f);
                }
                if (NPC.ai[1] >= 300f)
                {
                    NPC.ai[1] = 0f;
            ...
            else if (NPC.ai[0] == 3f)
            {
                ...
                if (NPC.ai[1] % 30f == 0f)
                {
                    ...
                    int num848 = Projectile.NewProjectile(NPC.GetSource_FromThis(), vector18.X, vector18.Y, num844, num845, ModContent.ProjectileType<HorsWaterBlast>(), expertMode ? 11 : 14, 0f, Main.myPlayer, 0f, 0f);
                }
                if (NPC.ai[1] >= 120f)
                {
                    NPC.ai[1] = 0f;
            ...
            else if (NPC.ai[0] == 4f)
            {
                ...
                if (NPC.ai[1] % 20f == 0f)
                {
                    ...
                    int num833 = Projectile.NewProjectile(NPC.GetSource_FromThis(), vector18.X, vector18.Y, num829, num830, ModContent.ProjectileType<HorsWaterBlast>(), expertMode ? 13 : 17, 0f, Main.myPlayer, 0f, 0f);
                }
                if (NPC.ai[1] >= 240f)
                {
                    NPC.ai[1] = 0f;
