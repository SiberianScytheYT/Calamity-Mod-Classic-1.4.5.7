...
namespace CalRD.NPCs.Astral
{
    public class Atlas : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            NPC.aiStyle = -1;
            NPC.DeathSound = new SoundStyle("CalRD/Sounds/NPCKilled/AtlasDeath");
            Banner = NPC.type;
        ...
        public override void AI()
        {
            ...
            if (!NPC.HasValidTarget || idling)
            {
                ...
                else
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle("CalRD/Sounds/Custom/AtlasSad0"), NPC.Center);
                }
            }
        ...
        private void DoSwingUpdate()
        {
            ...
            {
                SoundEngine.PlaySound(new SoundStyle("CalRD/Sounds/Custom/AtlasSwing"), NPC.Center);
            }
        ...
        private void DoIdleAI()
        {
            ...
            else
            {
                ...
                if (idle_impulseWalk) //if we've just decided to stroll
                {
                    ...
                    //PLAY SOUND (IDLE)
                    SoundEngine.PlaySound(new SoundStyle("CalRD/Sounds/Custom/AtlasIdle" + Main.rand.Next(2)), NPC.Center);
                }
                else
                {
                    NPC.velocity.X *= 0.9f;
        ...
        private void DoTargetAI()
        {
            ...
            if (target_counter > 180)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("CalRD/Sounds/Custom/AtlasSad1"), NPC.Center);
            }
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if (NPC.soundDelay == 0)
            {
                ...
                {
                    case 0:
                        SoundEngine.PlaySound(new SoundStyle("CalRD/Sounds/NPCHit/AtlasHurt0"), NPC.Center);
                        break;
                    case 1:
                        SoundEngine.PlaySound(new SoundStyle("CalRD/Sounds/NPCHit/AtlasHurt1"), NPC.Center);
                        break;
                    case 2:
                        SoundEngine.PlaySound(new SoundStyle("CalRD/Sounds/NPCHit/AtlasHurt2"), NPC.Center);
                        break;
                }
            }
            ...
            if (NPC.life <= 0)
            {
                ...
                {
                    //head
                    Gore.NewGore(NPC.GetSource_FromThis(), NPC.Top, NPC.velocity * 0.5f, Mod.Find<ModGore>("AtlasGore4").Type);
                    //hand
                    Gore.NewGore(NPC.GetSource_FromThis(), NPC.direction == 1 ? NPC.Right : NPC.Left, NPC.velocity * 0.5f, Mod.Find<ModGore>("AtlasGore2").Type);
                    //rest
                    Gore.NewGore(NPC.GetSource_FromThis(), NPC.Center, NPC.velocity * 0.5f, Mod.Find<ModGore>("AtlasGore0").Type);
                    Gore.NewGore(NPC.GetSource_FromThis(), NPC.Center, NPC.velocity * 0.5f, Mod.Find<ModGore>("AtlasGore1").Type);
                    Gore.NewGore(NPC.GetSource_FromThis(), NPC.Center, NPC.velocity * 0.5f, Mod.Find<ModGore>("AtlasGore3").Type);
                    Gore.NewGore(NPC.GetSource_FromThis(), NPC.Center, NPC.velocity * 0.5f, Mod.Find<ModGore>("AtlasGore5").Type);
                    Gore.NewGore(NPC.GetSource_FromThis(), NPC.Center, NPC.velocity * 0.5f, Mod.Find<ModGore>("AtlasGore6").Type);
                }
            }
        }
