...
namespace CalRD.NPCs.SunkenSea
{
    public class GhostBell : ModNPC
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            vector -= new Vector2((float)ModContent.Request<Texture2D>("CalRD/NPCs/SunkenSea/GhostBellGlow").Value.Width, (float)(ModContent.Request<Texture2D>("CalRD/NPCs/SunkenSea/GhostBellGlow").Value.Height / Main.npcFrameCount[NPC.type])) * 1f / 2f;
            ...
            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalRD/NPCs/SunkenSea/GhostBellGlow").Value, vector,
