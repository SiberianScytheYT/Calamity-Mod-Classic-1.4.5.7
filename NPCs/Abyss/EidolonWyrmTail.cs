...
namespace CalRD.NPCs.Abyss
{
    public class EidolonWyrmTail : ModNPC
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            vector -= new Vector2((float)ModContent.Request<Texture2D>("CalRD/NPCs/Abyss/EidolonWyrmTailGlow").Value.Width, (float)(ModContent.Request<Texture2D>("CalRD/NPCs/Abyss/EidolonWyrmTailGlow").Value.Height / Main.npcFrameCount[NPC.type])) * 1f / 2f;
            ...
            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalRD/NPCs/Abyss/EidolonWyrmTailGlow").Value, vector,
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if (NPC.life <= 0)
            {
                ...
                {  
                    ...
                    Gore.NewGore(NPC.GetSource_FromThis(), NPC.Center, NPC.velocity, Mod.Find<ModGore>("Wyrm4").Type, 1f);
                }
            }
        }
