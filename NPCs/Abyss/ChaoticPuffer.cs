    ...
    public class ChaoticPuffer : ModNPC
    {
        ...
        public void Boom()
        {
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient && puffedUp)
            {
                ...
                int boom = Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.Center.X, NPC.Center.Y, 0, 0, projectileType, damageBoom, 0f, Main.myPlayer, 0f, 0f);
            }
            NPC.netUpdate = true;
        }
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            vector -= new Vector2((float)ModContent.Request<Texture2D>("CalRD/NPCs/Abyss/ChaoticPufferGlow").Value.Width, (float)(ModContent.Request<Texture2D>("CalRD/NPCs/Abyss/ChaoticPufferGlow").Value.Height / Main.npcFrameCount[NPC.type])) * 1f / 2f;
            ...
            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalRD/NPCs/Abyss/ChaoticPufferGlow").Value, vector,
        ...
        public override void OnKill()
        {
            ...
            DropHelper.DropItemCondition(NPC.GetSource_FromThis(), NPC, ModContent.ItemType<ChaoticOre>(), NPC.downedGolemBoss, 1f, 10, 26);
        }
