...
namespace CalRD.NPCs.Abyss
{
    public class DevilFish : ModNPC
    {
            ...
            if (hitCounter >= 5 && !brokenMask)
            {
                ...
                for(int i = 1; i < 4; i++)
                {
                    if (Main.netMode != NetmodeID.Server)
                        Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity, Mod.Find<ModGore>("DevilFishMask" + i).Type, 1f);
                }
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            vector -= new Vector2((float)ModContent.Request<Texture2D>("CalRD/NPCs/Abyss/DevilFishGlow").Value.Width, (float)(ModContent.Request<Texture2D>("CalRD/NPCs/Abyss/DevilFishGlow").Value.Height / Main.npcFrameCount[NPC.type])) * 1f / 2f;
            ...
            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalRD/NPCs/Abyss/DevilFishGlow").Value, vector,
        ...
        public override void OnKill()
        {
            ...
            DropHelper.DropItemCondition(NPC.GetSource_FromThis(), NPC, ModContent.ItemType<ChaoticOre>(), NPC.downedGolemBoss, 1f, 3, 9);
            DropHelper.DropItemCondition(NPC.GetSource_FromThis(), NPC, ModContent.ItemType<Hellborn>(), NPC.downedGolemBoss, 200, 1, 1);
        }
