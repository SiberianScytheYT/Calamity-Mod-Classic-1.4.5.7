...
namespace CalRD.NPCs.Abyss
{
    public class BobbitWormHead : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            while (draw)
            {
                ...
                else
                {
                    ...
                    Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalRD/NPCs/Abyss/BobbitWormSegment").Value, new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
                        new Microsoft.Xna.Framework.Rectangle?(new Rectangle(0, 0, ModContent.Request<Texture2D>("CalRD/NPCs/Abyss/BobbitWormSegment").Value.Width, ModContent.Request<Texture2D>("CalRD/NPCs/Abyss/BobbitWormSegment").Value.Height)), color, rotation,
                        new Vector2((float)ModContent.Request<Texture2D>("CalRD/NPCs/Abyss/BobbitWormSegment").Value.Width * 0.5f, (float)ModContent.Request<Texture2D>("CalRD/NPCs/Abyss/BobbitWormSegment").Value.Height * 0.5f), 1f, SpriteEffects.None, 0f);
                }
            }
            return true;
        }
        ...
        public override void OnKill()
        {
            ...
            DropHelper.DropItemCondition(NPC.GetSource_FromThis(), NPC, ModContent.ItemType<BobbitHook>(), CalamityWorld.downedPolterghast, 3, 1, 1);
        }
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if (NPC.life <= 0)
            {
                if (Main.netMode != NetmodeID.Server)
                {
                    ...
                    Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity, Mod.Find<ModGore>("BobbitWorm").Type, 1f);
                    Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity, Mod.Find<ModGore>("BobbitWorm2").Type, 1f);
                    Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity, Mod.Find<ModGore>("BobbitWorm3").Type, 1f);
                    Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity, Mod.Find<ModGore>("BobbitWorm4").Type, 1f);
                }
            }
        }
    }
