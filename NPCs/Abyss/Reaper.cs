    ...
    public class Reaper : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (NPC.soundDelay <= 0)
            {
                ...
                if (hasBeenHit)
                {
                    SoundEngine.PlaySound(new SoundStyle("CalRD/Sounds/Custom/ReaperEnragedRoar"), NPC.position);
                }
                else
                {
                    SoundEngine.PlaySound(new SoundStyle("CalRD/Sounds/Custom/ReaperSearchRoar"), NPC.position);
                }
            }
            if (phase3 || phase1)
            {
