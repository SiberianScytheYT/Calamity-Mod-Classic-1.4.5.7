...
namespace CalRD.NPCs.DevourerofGods
{
    ...
    public class DevourerofGodsBodyS : ModNPC
    {
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
		{
			...
			{
				texture2D15 = ModContent.Request<Texture2D>("CalRD/NPCs/DevourerofGods/DevourerofGodsBodySGlow").Value;
				Color color37 = Color.Lerp(Color.White, Color.Fuchsia, 0.5f);

				spriteBatch.Draw(texture2D15, vector43, NPC.frame, color37, NPC.rotation, vector11, NPC.scale, spriteEffects, 0f);

				texture2D15 = ModContent.Request<Texture2D>("CalRD/NPCs/DevourerofGods/DevourerofGodsBodySGlow2").Value;
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            if (NPC.life <= 0)
            {
                if (Main.netMode != NetmodeID.Server)
                {
                    ...
                    Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity * randomSpread * Main.rand.NextFloat(), Mod.Find<ModGore>("DoGS6").Type, 1f);
                }
