...
namespace CalRD.Walls
{
    public class ProfanedSlabWall : ModWall
    {
        public override void SetStaticDefaults()
        {
            ...
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.Walls.ProfanedSlabWall>();
        ...
        {
            Texture2D sprite = ModContent.Request<Texture2D>("CalRD/Walls/ProfanedSlabWall").Value;
