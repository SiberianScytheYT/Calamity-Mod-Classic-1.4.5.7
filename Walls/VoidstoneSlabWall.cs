...
namespace CalRD.Walls
{
    public class VoidstoneSlabWall : ModWall
    {
        public override void SetStaticDefaults()
        {
            ...
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.Walls.VoidstoneSlabWall>();
        ...
        {
            Texture2D sprite = ModContent.Request<Texture2D>("CalRD/Walls/VoidstoneSlabWall").Value;
