...
namespace CalRD.UI
{
	public class RipperUI
    {
        ...
        public static void Draw(SpriteBatch spriteBatch, Player player)
        {
            ...
            Texture2D rageBarTex = ModContent.Request<Texture2D>("CalRD/ExtraTextures/UI/RageBar", AssetRequestMode.ImmediateLoad).Value;
            Texture2D rageBorderTex = ModContent.Request<Texture2D>("CalRD/ExtraTextures/UI/RageBarBorder", AssetRequestMode.ImmediateLoad).Value;
            Texture2D rageAnimTex = ModContent.Request<Texture2D>("CalRD/ExtraTextures/UI/RageFullAnimation", AssetRequestMode.ImmediateLoad).Value;
            Texture2D adrenBarTex = ModContent.Request<Texture2D>("CalRD/ExtraTextures/UI/AdrenalineBar", AssetRequestMode.ImmediateLoad).Value;
            Texture2D adrenBorderTex = ModContent.Request<Texture2D>("CalRD/ExtraTextures/UI/AdrenalineBarBorder", AssetRequestMode.ImmediateLoad).Value;
            Texture2D adrenAnimTex = ModContent.Request<Texture2D>("CalRD/ExtraTextures/UI/AdrenalineFullAnimation", AssetRequestMode.ImmediateLoad).Value;
