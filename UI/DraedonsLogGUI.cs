...
namespace CalRD.UI
{
	public abstract class DraedonsLogGUI : PopupGUI
    {
        ...
        {
            Texture2D pageTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/UI/DraedonsLogPage", AssetRequestMode.ImmediateLoad).Value;
        ...
        public void DrawArrows(SpriteBatch spriteBatch, float xResolutionScale, float yResolutionScale, float yPageBottom, Rectangle mouseRectangle)
        {
            ...
            Texture2D arrowTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/UI/DraedonsLogArrow", AssetRequestMode.ImmediateLoad).Value;
            if (Page > 0)
            {
                ...
                {
                    arrowTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/UI/DraedonsLogArrowHover", AssetRequestMode.ImmediateLoad).Value;
