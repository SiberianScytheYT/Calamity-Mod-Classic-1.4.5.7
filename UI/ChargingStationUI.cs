...
namespace CalRD.UI
{
    public class ChargingStationUI
    {
        ...
        public static void Draw(SpriteBatch spriteBatch)
        {
            ...
            else if (mouseRect.Intersects(powercellSlotRect))
            {
                ...
                if (Main.mouseLeft && Main.mouseLeftRelease)
                {
                    ...
                    {
                        DropHelper.DropItem(new EntitySource_TileEntity(charger), p, powercellID, powercell.stack);
        ...
        {
            Texture2D slotBackgroundTex = ModContent.Request<Texture2D>("CalRD/ExtraTextures/UI/ChargerWeaponSlot", AssetRequestMode.ImmediateLoad).Value;
