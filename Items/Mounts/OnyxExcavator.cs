...
namespace CalRD.Items.Mounts
{
	public class OnyxExcavator : ModMount
	{
		public override void SetStaticDefaults()
		{
			...
			{
				MountData.backTextureExtra = ModContent.Request<Texture2D>("CalRD/Items/Mounts/OnyxExcavatorExtra");
				MountData.frontTextureExtra = ModContent.Request<Texture2D>("CalRD/Items/Mounts/OnyxExcavatorExtra2");
