...
*/
		...
		{
			Texture2D texture = ModContent.Request<Texture2D>("CalRD/Items/PermanentBoosters/Ectoheart_Animated").Value;
		...
		{
			Texture2D texture = ModContent.Request<Texture2D>("CalRD/Items/PermanentBoosters/EctoheartGlow").Value;
