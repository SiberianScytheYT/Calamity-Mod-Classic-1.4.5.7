...
*/
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            Projectile.NewProjectile(source, position.X, position.Y, velocity.X, velocity.Y, type, damage, Item.knockBack, Main.myPlayer, 1f);
            ...
            for (int num108 = 0; num108 < num107; num108++)
            {
                ...
                int proj = Projectile.NewProjectile(source, vector2.X, vector2.Y, speedX4, speedY5, ProjectileID.HallowStar, damage / 3, Item.knockBack, player.whoAmI, 0f, (float)Main.rand.Next(5));
