...
*/
        ...
        {
			Item.DrawItemGlowmaskSingleFrame(spriteBatch, rotation, ModContent.Request<Texture2D>("CalRD/Items/Weapons/Melee/TheEnforcerGlow").Value);
        }
        ...
        public override void OnHitNPC(Player player, NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            for (int num108 = 0; num108 < num107; num108++)
            {
                ...
                num80 = num72 / num80;
                Projectile.NewProjectile(player.GetSource_ItemUse(Item), vector2.X, vector2.Y, 0f, 0f, ModContent.ProjectileType<EssenceFlame2>(), (int)(Item.damage * (player.GetDamage(DamageClass.Generic).Additive + player.GetDamage(DamageClass.Melee).Additive - 1f) * 0.25f), num74, i, 0f, (float)Main.rand.Next(3));
            }
        }
