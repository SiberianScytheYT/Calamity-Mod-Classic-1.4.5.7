...
*/
        ...
        {
            Projectile.NewProjectile(source, position.X, position.Y, velocity.X, velocity.Y, ModContent.ProjectileType<FulgurationHalberdProj>(), damage, Item.knockBack, player.whoAmI, 0f, 0f);
            return false;
        }
