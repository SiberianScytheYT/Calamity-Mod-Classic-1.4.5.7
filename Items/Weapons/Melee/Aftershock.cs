...
*/
        ...
        public override void OnHitNPC(Player player, NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            Projectile.NewProjectile(player.GetSource_ItemUse(Item), vector2.X, vector2.Y, speedX4, speedY5, ModContent.ProjectileType<AftershockRock>(), (int)(Item.damage * (player.GetDamage(DamageClass.Generic).Additive + player.GetDamage(DamageClass.Melee).Additive - 1f)), Item.knockBack, player.whoAmI, 0f, (float)Main.rand.Next(10));
        }
