...
*/
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            float knockback1 = Item.knockBack;
            knockback = player.GetWeaponKnockback(Item, knockback1);
            ...
            Projectile.NewProjectile(source, position.X, position.Y - player.gravDir * 4f, num208, num209, type, damage, Item.knockBack, i, 0f, (float)Main.rand.Next(12) / 6f);
            ...
            for (int index = 0; index < num6; ++index)
            {
                ...
                Projectile.NewProjectile(source, vector2.X, vector2.Y, SpeedX, SpeedY, type, damage, Item.knockBack, player.whoAmI, 0f, 0f);
            }
            return false;
        }
