...
*/
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            Vector2 baseVelocity = new Vector2(velocity.X, velocity.Y).SafeNormalize(Vector2.Zero) * BulletSpeed;
            ...
            for (int i = 0; i < NumBullets; ++i)
            {
                ...
                Projectile.NewProjectile(source, position, randomVelocity, ModContent.ProjectileType<IlluminatedBullet>(), damage, Item.knockBack, player.whoAmI, 0f, 0f);
            }
