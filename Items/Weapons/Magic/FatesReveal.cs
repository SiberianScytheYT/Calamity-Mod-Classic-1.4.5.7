...
*/
		...
		{
			Item.DrawItemGlowmaskSingleFrame(spriteBatch, rotation, ModContent.Request<Texture2D>("CalRD/Items/Weapons/Magic/FatesRevealGlow").Value);
		}
		...
		public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            for (int num108 = 0; num108 < num107; num108++)
            {
                ...
                Projectile.NewProjectile(source, spawnX, spawnY, 0f, 0f, type, damage, Item.knockBack, player.whoAmI, 0f, (float)Main.rand.Next(3));
            }
            return false;
        }
    }
