...
*/
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            Projectile.NewProjectile(source, position.X, position.Y, SpeedX2, SpeedY2, ModContent.ProjectileType<SeethingDischargeBrimstoneHellblast>(), damage, Item.knockBack, player.whoAmI, 0f, 0f);
            Projectile.NewProjectile(source, position.X, position.Y, SpeedX3, SpeedY3, type, damage, Item.knockBack, player.whoAmI, 0f, 0f);
            return false;
        }
    }
}
