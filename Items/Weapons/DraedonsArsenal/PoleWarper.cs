...
*/
		...
		{
			Projectile north = Projectile.NewProjectileDirect(Entity.GetSource_FromThis(), Main.MouseWorld + Vector2.UnitY * 30f, Vector2.Zero, type, damage, Item.knockBack, player.whoAmI);
			Projectile south = Projectile.NewProjectileDirect(Entity.GetSource_FromThis(), Main.MouseWorld - Vector2.UnitY * 30f, Vector2.Zero, type, damage, Item.knockBack, player.whoAmI);
			north.ai[1] = 1f;
			south.ai[1] = 0f;
