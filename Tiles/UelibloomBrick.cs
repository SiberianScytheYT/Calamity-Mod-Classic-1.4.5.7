...
namespace CalRD.Tiles
{
    public class UelibloomBrick : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            MinPick = 200;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.UelibloomBrick>();
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D leaves = ModContent.Request<Texture2D>("CalRD/Tiles/UelibloomBrick_Leaves").Value;
