...
namespace CalRD.Tiles.AstralSnow
{
	public class AstralIce : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            DustType = 173;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.AstralIce>();
