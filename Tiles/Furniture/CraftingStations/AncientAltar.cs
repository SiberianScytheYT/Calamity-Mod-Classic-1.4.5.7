...
namespace CalRD.Tiles.Furniture.CraftingStations
{
    public class AncientAltar : ModTile
    {
        ...
        {
            CalamityUtils.DrawStaticFlameEffect(ModContent.Request<Texture2D>("CalRD/Tiles/Furniture/CraftingStations/AncientAltarFlame").Value, i, j, offsetY: animationFrame * AnimationFrameHeight);
        }
