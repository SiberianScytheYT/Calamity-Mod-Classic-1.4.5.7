...
namespace CalRD.Tiles.FurnitureAshen
{
    public class SmoothBrimstoneSlag : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            MineResist = 5f;
            MinPick = 180;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.FurnitureAshen.SmoothBrimstoneSlag>();
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureAshen/SmoothBrimstoneSlagGlow").Value;
