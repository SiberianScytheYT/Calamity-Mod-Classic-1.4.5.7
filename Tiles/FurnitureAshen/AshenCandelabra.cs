...
namespace CalRD.Tiles.FurnitureAshen
{
    public class AshenCandelabra : ModTile
    {
        ...
        {
            CalamityUtils.DrawStaticFlameEffect(ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureAshen/AshenCandelabraFlame").Value, i, j, offsetY: animationFrame * AnimationFrameHeight);
        }
