...
namespace CalRD.Tiles.FurnitureAshen
{
    public class AshenChandelier : ModTile
    {
        ...
        {
            CalamityUtils.DrawStaticFlameEffect(ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureAshen/AshenChandelierFlame").Value, i, j, offsetY: animationFrame * AnimationFrameHeight);
        }
