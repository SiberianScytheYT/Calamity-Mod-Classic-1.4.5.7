...
namespace CalRD.Tiles.FurnitureOccult
{
    public class OccultStone : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            MineResist = 10f;
            MinPick = 200;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.FurnitureOccult.OccultStone>();
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D cloth = ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureOccult/OccultStone_Cloth").Value;
