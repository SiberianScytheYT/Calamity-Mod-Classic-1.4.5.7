...
namespace CalRD.Tiles.FurnitureOccult
{
    ...
    {
         public override LocalizedText DefaultContainerName(int frameX, int frameY) => ItemLoader.GetItem(ModContent.ItemType<Items.Placeables.FurnitureOccult.OccultDresser>()).GetLocalization("DisplayName");
        ...
        public override void SetStaticDefaults()
        {
            ...
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.FurnitureOccult.OccultDresser>();
        }
        ...
        {
            CalamityUtils.DresserMouseFar<Items.Placeables.FurnitureOccult.OccultDresser>();
        }

        public override void MouseOver(int i, int j)
        {
            CalamityUtils.DresserMouseOver<Items.Placeables.FurnitureOccult.OccultDresser>();
        }
