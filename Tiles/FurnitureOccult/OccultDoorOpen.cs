...
namespace CalRD.Tiles.FurnitureOccult
{
    public class OccultDoorOpen : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            TileID.Sets.CloseDoorID[Type] = ModContent.TileType<OccultDoorClosed>();
        }
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 48, ModContent.ItemType<Items.Placeables.FurnitureOccult.OccultDoor>());
        }*/
