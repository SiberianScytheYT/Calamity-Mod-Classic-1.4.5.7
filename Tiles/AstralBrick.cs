...
namespace CalRD.Tiles
{
    public class AstralBrick : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            MinPick = 150;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.AstralBrick>();
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            xPos += xOffset;
            yPos += yOffset;
            Texture2D glowmask = ModContent.Request<Texture2D>("CalRD/Tiles/AstralBrickGlow").Value;
