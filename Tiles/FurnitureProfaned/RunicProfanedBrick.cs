...
namespace CalRD.Tiles.FurnitureProfaned
{
    public class RunicProfanedBrick : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            MineResist = 4f;
            MinPick = 225;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.FurnitureProfaned.RunicProfanedBrick>();
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            xPos += xOffset;
            yPos += yOffset;
            Texture2D glowmask = ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureProfaned/RunicProfanedBrickGlow").Value;
