...
namespace CalRD.Tiles.FurnitureProfaned
{
    public class ProfanedLantern : ModTile
    {
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Placeables.FurnitureProfaned.ProfanedLantern>());
        }*/
        ...
        {
            CalamityUtils.DrawFlameEffect(ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureProfaned/ProfanedLanternFlame").Value, i, j);
        }
