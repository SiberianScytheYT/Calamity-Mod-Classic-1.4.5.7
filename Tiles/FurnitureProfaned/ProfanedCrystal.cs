...
namespace CalRD.Tiles.FurnitureProfaned
{
    public class ProfanedCrystal : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            MineResist = 1f;
            MinPick = 225;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.FurnitureProfaned.ProfanedCrystal>();
