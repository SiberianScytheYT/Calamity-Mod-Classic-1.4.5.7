...
namespace CalRD.Tiles.FurnitureAstral
{
    public class MonolithDresser : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.FurnitureAstral.MonolithDresser>();
        }
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureAstral/MonolithDresserGlow").Value;
        ...
        {
            CalamityUtils.DresserMouseFar<Items.Placeables.FurnitureAstral.MonolithDresser>();
        }

        public override void MouseOver(int i, int j)
        {
            CalamityUtils.DresserMouseOver<Items.Placeables.FurnitureAstral.MonolithDresser>();
        }
