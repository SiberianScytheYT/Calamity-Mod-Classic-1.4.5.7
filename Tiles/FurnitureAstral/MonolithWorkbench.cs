...
namespace CalRD.Tiles.FurnitureAstral
{
    public class MonolithWorkBench : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            // name.SetDefault("Monolith Work Bench");
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureAstral/MonolithWorkBenchGlow").Value;
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 16, ModContent.ItemType<Items.Placeables.FurnitureAstral.MonolithWorkBench>());
        }*/
    }
}
