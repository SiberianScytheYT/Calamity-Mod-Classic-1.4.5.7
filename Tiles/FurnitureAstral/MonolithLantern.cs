...
namespace CalRD.Tiles.FurnitureAstral
{
    public class MonolithLantern : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureAstral/MonolithLanternGlow").Value;
            ...
            Texture2D glowmaskBright = ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureAstral/MonolithLanternFlame").Value;
