...
namespace CalRD.Tiles.FurnitureAstral
{
    public class MonolithPiano : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureAstral/MonolithPianoGlow").Value;
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Placeables.FurnitureAstral.MonolithPiano>());
        }*/
    }
}
