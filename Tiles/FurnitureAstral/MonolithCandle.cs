...
namespace CalRD.Tiles.FurnitureAstral
{
    public class MonolithCandle : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.FurnitureAstral.MonolithCandle>();
        }
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureAstral/MonolithCandleGlow").Value;
            ...
            Texture2D glowmaskBright = ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureAstral/MonolithCandleFlame").Value;
