...
namespace CalRD.Tiles
{
    public class CryonicBrick : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            MinPick = 100;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.CryonicBrick>();
