...
namespace CalRD.Tiles.Ores
{
    public class ChaoticOre : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            DustType = 105;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.Ores.ChaoticOre>();
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalRD/Tiles/Ores/ChaoticOreGlow").Value;
