...
namespace CalRD.Tiles.Ores
{
    public class AstralOre : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            MinPick = 210;
            DustType = 173;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.Ores.AstralOre>();
