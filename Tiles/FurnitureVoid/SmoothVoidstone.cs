...
namespace CalRD.Tiles.FurnitureVoid
{
    public class SmoothVoidstone : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            MineResist = 7f;
            MinPick = 180;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.FurnitureVoid.SmoothVoidstone>();
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            xOffset *= 288;
            xPos += xOffset;
            Texture2D glowmask = ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureVoid/SmoothVoidstoneGlow").Value;
