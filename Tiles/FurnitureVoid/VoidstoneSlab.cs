...
namespace CalRD.Tiles.FurnitureVoid
{
    public class VoidstoneSlab : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            MineResist = 7f;
            MinPick = 180;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.FurnitureVoid.VoidstoneSlab>();
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            if (Main.tile[i, j].TileType == ModContent.TileType<VoidstoneSlab>())
            {
                ...
                yOffset *= 270;
                yPos += yOffset;
                Texture2D glowmask = ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureVoid/VoidstoneSlabGlow").Value;
