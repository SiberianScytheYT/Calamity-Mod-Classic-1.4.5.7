...
namespace CalRD.Tiles.DraedonStructures
{
    public class ReinforcedCrate : ModTile
    {
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 32, ModContent.ItemType<ReinforcedCrateItem>());
        }*/
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalRD/Tiles/DraedonStructures/ReinforcedCrateGlow").Value;
