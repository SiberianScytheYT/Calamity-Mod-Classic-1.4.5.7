...
namespace CalRD.Tiles.AstralDesert
{
    public class HardenedAstralSand : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            DustType = 108;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.HardenedAstralSand>();
