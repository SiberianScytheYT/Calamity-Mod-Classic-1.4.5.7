...
namespace CalRD.Tiles.FurnitureCosmilite
{
	public class CosmiliteBasinTile : ModTile
	{
        ...
        {
            CalamityUtils.DrawStaticFlameEffect(ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureCosmilite/CosmiliteBasinFlame").Value, i, j, offsetY: animationFrame * AnimationFrameHeight);
        }
