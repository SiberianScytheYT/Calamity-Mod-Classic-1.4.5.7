...
namespace CalRD.Tiles.FurnitureCosmilite
{
    public class CosmiliteBrick : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            MineResist = 5f;
            MinPick = 275;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.FurnitureCosmilite.CosmiliteBrick>();
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureCosmilite/CosmiliteBrickGlow").Value;
