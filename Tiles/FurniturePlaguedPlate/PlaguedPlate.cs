...
namespace CalRD.Tiles.FurniturePlaguedPlate
{
    public class PlaguedPlate : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            MineResist = 3f;
            MinPick = 210;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.FurniturePlaguedPlate.PlaguedPlate>();
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalRD/Tiles/FurniturePlaguedPlate/PlaguedPlateGlow").Value;
