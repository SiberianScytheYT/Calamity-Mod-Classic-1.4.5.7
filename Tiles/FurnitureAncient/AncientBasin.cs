...
namespace CalRD.Tiles.FurnitureAncient
{
    public class AncientBasin : ModTile
    {
        ...
        {
            CalamityUtils.DrawStaticFlameEffect(ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureAncient/AncientBasinFlame").Value, i, j, offsetY: animationFrame * AnimationFrameHeight);
        }
