...
namespace CalRD.Tiles.FurnitureStratus
{
    public class StratusBricks : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            MineResist = 5f;
            MinPick = 225;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.FurnitureStratus.StratusBricks>();
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalRD/Tiles/FurnitureStratus/StratusBricksGlow").Value;
