...
namespace CalRD.Tiles.Crags
{
	public class BrimstoneSlag : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            MineResist = 3f;
            MinPick = 180;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.BrimstoneSlag>();
        ...
        /*public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D sprite = ModContent.Request<Texture2D>("CalRD/Tiles/Crags/BrimstoneSlagGlow");
