...
namespace CalRD.Tiles.Abyss
{
    public class Voidstone : ModTile
    {
        ...
        {
            if (!Main.dedServ)
                GlowTexture = ModContent.Request<Texture2D>("CalRD/Tiles/Abyss/Voidstone_Glowmask").Value;
            ...
            MineResist = 10f;
            MinPick = 180;
            // ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeables.Voidstone>();
