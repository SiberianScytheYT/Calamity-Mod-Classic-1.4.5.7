        ...
        public override void AI()
        {
            ...
            if (shouldShoot && Main.myPlayer == Projectile.owner)
            {
                ...
                if (canShoot)
                {
					...
					int snowball = Projectile.NewProjectile(Entity.GetSource_FromThis(), sourceS, snowballVel, projType, dmg, kBack, Projectile.owner);
					...
					if (Main.rand.NextBool(5)) //ice chunk
					{
						...
						int iceChunk = Projectile.NewProjectile(Entity.GetSource_FromThis(), sourceC, chunkVel, ModContent.ProjectileType<FlurrystormIceChunk>(), (int)(dmg * 1.5), (int)(kBack * 1.5), Projectile.owner, 0f, chunkVel.Y);
