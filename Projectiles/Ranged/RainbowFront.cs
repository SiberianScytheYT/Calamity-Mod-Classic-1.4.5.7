		...
		public override void AI()
		{
			...
			if (Projectile.owner == Main.myPlayer)
			{
				...
				if (Projectile.localAI[0] > 4f)
				{
					...
					Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, Projectile.velocity.X * (1f / 1000f), Projectile.velocity.Y * (1f / 1000f), ModContent.ProjectileType<RainbowTrail>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
				}
