...
namespace CalRD.Projectiles.Ranged
{
	public class SputterCometBig : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                int flash = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<Flash>(), (int)((double)Projectile.damage * 0.5), 0f, Projectile.owner, 0f, 0f);
