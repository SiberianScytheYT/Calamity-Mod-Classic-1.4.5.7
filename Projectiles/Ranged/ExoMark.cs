...
namespace CalRD.Projectiles.Ranged
{
    public class ExoMark : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<ExoTornado>(), Projectile.damage, 2f, Projectile.owner, 1f, 0f);
            }
