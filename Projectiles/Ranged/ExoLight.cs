...
namespace CalRD.Projectiles.Ranged
{
    public class ExoLight : ModProjectile
    {
        ...
        {
            Texture2D lightTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/PhotovisceratorLight").Value;
            for (int i = 0; i < Projectile.oldPos.Length; i++)
            {
                ...
                Main.spriteBatch.Draw(lightTexture, drawPosition, null, outerColor, 0f, lightTexture.Size() * 0.5f, outerScale * 0.6f, SpriteEffects.None, 0);
                Main.spriteBatch.Draw(lightTexture, drawPosition, null, innerColor, 0f, lightTexture.Size() * 0.5f, innerScale * 0.6f, SpriteEffects.None, 0);
            }
            return false;
        }
