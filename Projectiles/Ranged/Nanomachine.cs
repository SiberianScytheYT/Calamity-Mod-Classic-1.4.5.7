...
namespace CalRD.Projectiles.Ranged
{
    public class Nanomachine : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Ranged/Nanomachine").Value;
            if (Projectile.localAI[1] == 2)
                texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Ranged/Nanomachine2").Value;
