...
namespace CalRD.Projectiles.Ranged
{
    ...
    {
        public override string Texture => "CalRD/Projectiles/Enemy/FlakAcid";
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Main.rand.NextBool(3))
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, angle.ToRotationVector2() * Main.rand.NextFloat(4f, 16f),
