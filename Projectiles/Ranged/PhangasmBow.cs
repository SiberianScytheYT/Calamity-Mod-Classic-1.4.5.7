...
namespace CalRD.Projectiles.Ranged
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Ranged/Phangasm";
            ...
            if (flag15 && Main.myPlayer == Projectile.owner)
            {
                ...
                if (flag16)
                {
                    ...
                    for (int num43 = 0; num43 < 10; num43++)
                    {
                        ...
                        int num44 = Projectile.NewProjectile(Entity.GetSource_FromThis(), vector21, vector20, num42, weaponDamage2, weaponKnockback2, Projectile.owner, 0f, 0f);
