    ...
    public class AstrealArrow : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[1] >= 180f)
            {
                ...
                {
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Projectile.velocity, ModContent.ProjectileType<AstrealFlame>(), (int)(Projectile.damage * 0.5), Projectile.knockBack, Projectile.owner, 0f, 0f);
                }
            }
        }
