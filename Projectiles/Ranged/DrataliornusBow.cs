...
namespace CalRD.Projectiles.Ranged
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Ranged/Drataliornus";
        ...
        public override void AI() //mostly phangasm code
        {
            ...
            if (timeToFire && Main.myPlayer == Projectile.owner)
            {
                if (canFire) //fire an angery flame
                {
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), position, speed, type, damage, Projectile.knockBack, Projectile.owner, ai0, 0f);
