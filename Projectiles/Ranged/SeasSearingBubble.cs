			...
			if (Projectile.ai[0] == 1f)
			{
				for (int x = 0; x < 2; x++)
				{
					if (Projectile.owner == Main.myPlayer)
					{
						...
						Projectile bubble = CalamityUtils.ProjectileBarrage(Projectile.GetSource_FromThis(), Projectile.Center, targetPos, Main.rand.NextBool(), 1000f, 1400f, 80f, 900f, Main.rand.NextFloat(20f, 25f), ModContent.ProjectileType<SeasSearingBubble>(), Projectile.damage / 2, 1f, Projectile.owner);
