...
namespace CalRD.Projectiles.Ranged
{
    ...
    {
        public override string Texture => "CalRD/Projectiles/Enemy/SulphuricAcidBubble";
        ...
        public override void AI()
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                if (counter >= 120f)
                {
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, vector15.X, vector15.Y, ModContent.ProjectileType<SulphuricAcidMist2>(), (int)(250f * Main.player[Projectile.owner].RangedDamage()), 1f, Projectile.owner, 0f, 0f);
                }
                else
                    counter += 1f;
            }
