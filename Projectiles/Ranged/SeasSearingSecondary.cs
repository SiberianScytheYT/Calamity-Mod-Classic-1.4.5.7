...
namespace CalRD.Projectiles.Ranged
{
	public class SeasSearingSecondary : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                int endoftime = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<TyphoonBubble>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
