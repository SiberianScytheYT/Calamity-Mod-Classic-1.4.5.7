...
namespace CalRD.Projectiles.Ranged
{
    ...
    {
        public override string Texture => "CalRD/Projectiles/Melee/GalacticaComet";
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<NorfleetExplosion>(), (int)(Projectile.damage * 0.3), Projectile.knockBack * 0.1f, Projectile.owner);
            }
