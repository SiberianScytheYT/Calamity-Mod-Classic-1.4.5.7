...
namespace CalRD.Projectiles.Ranged
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Ranged/FlakKraken";
            ...
            if (flag10 && Main.myPlayer == Projectile.owner)
            {
                ...
                if (flag12)
                {
                    if (Projectile.ai[0] == 1f)
                    {
                        ...
                        Projectile.NewProjectile(Entity.GetSource_FromThis(), vector2.X, vector2.Y, 0f, 0f, ModContent.ProjectileType<FlakKrakenProj>(), num29, Projectile.knockBack, Projectile.owner, 0f, (float)Projectile.whoAmI);
                        Projectile.netUpdate = true;
                    }
                }
                else
