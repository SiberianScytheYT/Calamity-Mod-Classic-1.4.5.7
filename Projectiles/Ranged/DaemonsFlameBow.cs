...
namespace CalRD.Projectiles.Ranged
{
    public class DaemonsFlameBow : ModProjectile
    {
            ...
            if (flag15 && Main.myPlayer == Projectile.owner)
            {
                ...
                if (flag16)
                {
                    ...
                    for (int num43 = 0; num43 < 4; num43++)
                    {
                        ...
                        int num44 = Projectile.NewProjectile(Entity.GetSource_FromThis(), vector21.X, vector21.Y, vector20.X, vector20.Y, num42, weaponDamage2, weaponKnockback2, Projectile.owner, 0f, 0f);
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), vector3.X, vector3.Y, vector2.X, vector2.Y, ModContent.ProjectileType<DaemonsFlameArrow>(), weaponDamage2, weaponKnockback2, Projectile.owner, 0.0f, speedY);
                }
                else
                {
                    Projectile.Kill();
		...
		public override void PostDraw(Color lightColor)
		{
			...
			Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalRD/Projectiles/Ranged/DaemonsFlameBowGlow").Value, Projectile.Center - Main.screenPosition, new Microsoft.Xna.Framework.Rectangle?(new Rectangle(0, y6, texture2D13.Width, num214)), Color.White, Projectile.rotation, origin, Projectile.scale, spriteEffects, 0f);
		}
	}
}
