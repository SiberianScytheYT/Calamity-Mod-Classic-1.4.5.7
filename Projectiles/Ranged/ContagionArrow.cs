    ...
    public class ContagionArrow : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (addBallTimer <= 0)
            {
                ...
                {
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<ContagionBall>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
                }
                addBallTimer = 10;
            }
