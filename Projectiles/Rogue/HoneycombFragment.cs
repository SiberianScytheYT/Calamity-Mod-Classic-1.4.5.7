...
namespace CalRD.Projectiles.Rogue
{
	public class HoneycombFragment : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                Texture2D texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/HoneycombFragment2").Value;
            ...
            {
                Texture2D texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/HoneycombFragment3").Value;
