    ...
    public class HypothermiaShard : ModProjectile
    {
        ...
        */
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/HypothermiaShard2").Value;
            }
            if (Projectile.ai[0] == 2f)
            {
                texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/HypothermiaShard3").Value;
            }
            if (Projectile.ai[0] == 3f)
            {
                texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/HypothermiaShard4").Value;
            }
