	...
	public class SeafoamBombProj : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < (Projectile.Calamity().stealthStrike ? 5 : 1); i++)
            {
                ...
                Projectile.NewProjectile(Entity.GetSource_FromThis(), posX, posY, 0f, 0f, ModContent.ProjectileType<SeafoamBubble>(), (int)((double)Projectile.damage * 0.4), 0f, Projectile.owner, 0f, 0f);
            }

			CalamityUtils.ExplosionGores(Projectile.GetSource_FromThis(), Projectile.Center, (Projectile.Calamity().stealthStrike ? 6 : 3));
        }
    }
}
