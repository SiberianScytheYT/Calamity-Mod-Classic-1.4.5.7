...
namespace CalRD.Projectiles.Rogue
{
    ...
    {
		public override string Texture => "CalRD/Projectiles/Magic/AtlantisSpear";
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < numProj; i++)
            {
                ...
                int projectile2 = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, perturbedSpeed.X, perturbedSpeed.Y, ModContent.ProjectileType<BrackishSpear2>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
