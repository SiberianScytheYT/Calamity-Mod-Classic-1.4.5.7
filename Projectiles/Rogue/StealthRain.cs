...
namespace CalRD.Projectiles.Rogue
{
    ...
    {
        public override string Texture => "CalRD/Projectiles/Boss/ShaderainHostile";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                Texture2D texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/StealthRain2").Value;
