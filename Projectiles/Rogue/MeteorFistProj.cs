    ...
    public class MeteorFistProj : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (Projectile.Calamity().stealthStrike && Projectile.ai[1] > 0f && Projectile.penetrate != -1)
            {
                ...
                int p = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.position, newFistVelocity, ModContent.ProjectileType<MeteorFistProj>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0, AI1);
