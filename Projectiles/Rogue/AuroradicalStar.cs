    ...
    public class AuroradicalStar : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
			...
			if (Projectile.Calamity().stealthStrike && Main.myPlayer == Projectile.owner)
			{
				...
				int comet = Projectile.NewProjectile(Entity.GetSource_FromThis(), pos, velocity, ModContent.ProjectileType<CometQuasherMeteor>(), dmg, Projectile.knockBack, Projectile.owner, 0f, 0f);
