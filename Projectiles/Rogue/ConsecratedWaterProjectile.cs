...
namespace CalRD.Projectiles.Rogue
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Rogue/ConsecratedWater";
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Projectile.ai[1] == 0f)
            {
                ...
                {
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), result.ToVector2() * 16f, Vector2.Zero, ModContent.ProjectileType<BlueFlamePillar>(), Projectile.damage, 2f, Projectile.owner);
                }
            }
            //stealth strike
