...
namespace CalRD.Projectiles.Rogue
{
    public class FinalDawnReticle : ModProjectile
    {
        ...
        {
            Texture2D ring = TextureAssets.Projectile[Projectile.type].Value;
			Texture2D symbol = ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/FinalDawnReticleSymbol").Value;
            Main.spriteBatch.Draw(symbol,
