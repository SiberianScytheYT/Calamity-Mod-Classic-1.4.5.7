...
namespace CalRD.Projectiles.Rogue
{
	...
	{
        public override string Texture => "CalRD/Items/Weapons/Rogue/DuststormInABottle";
		...
		public override void OnKill(int timeLeft)
		{
			...
			if (Projectile.owner == Main.myPlayer)
			{
				for (int index = 0; index < cloudAmt; index++)
				{
					...
					Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, velocity, projType, Projectile.damage, Projectile.knockBack * 0.5f, Projectile.owner, stealth ? 1f : 0f, (float)Main.rand.Next(-45, 1));
				}
			}
		}
	}
