...
namespace CalRD.Projectiles.Rogue
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Rogue/SpentFuelContainer";
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                int proj = Projectile.NewProjectile(Entity.GetSource_FromThis(), result.ToVector2() * 16f, Vector2.Zero, ModContent.ProjectileType<SulphuricNukesplosion>(), Projectile.damage, 2f, Projectile.owner);
