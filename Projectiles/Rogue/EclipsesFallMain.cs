	...
	public class EclipsesFallMain : ModProjectile
	{
		...
		private void SpawnSpears(Vector2 targetPos)
		{
			...
			for (int n = 0; n < spearAmt; n++)
			{
				...
				CalamityUtils.ProjectileRain(Projectile.GetSource_FromThis(), targetPos, 400f, 100f, 500f, 800f, 29f, ModContent.ProjectileType<EclipsesSmol>(), (int)(Projectile.damage * dmgMult), Projectile.knockBack * kBMult, Projectile.owner);
			}
		}
