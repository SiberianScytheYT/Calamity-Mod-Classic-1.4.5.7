...
namespace CalRD.Projectiles.Rogue
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Rogue/Sandslasher";
        ...
        public override void AI()
        {
            ...
            if(Projectile.Calamity().stealthStrike && Projectile.ai[1] >= 5f)
            {
                ...
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.position, speed, ModContent.ProjectileType<DuststormCloud>(), (int)(Projectile.damage * 0.4), 0f, Projectile.owner);
                Projectile.ai[1] = 0;
            }
        }
