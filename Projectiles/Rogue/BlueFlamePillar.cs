...
namespace CalRD.Projectiles.Rogue
{
    public class BlueFlamePillar : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/BlueFlamePillar").Value, Projectile.Center - Main.screenPosition, frame, Color.White, Projectile.rotation, Projectile.Size / 2, 1f, SpriteEffects.None, 0f);
            return false;
        }
    }
}
