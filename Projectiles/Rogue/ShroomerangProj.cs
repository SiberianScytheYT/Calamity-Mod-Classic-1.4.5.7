...
namespace CalRD.Projectiles.Rogue
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Rogue/Shroomerang";
        ...
        public override void AI()
        {
			...
			if (Projectile.Calamity().stealthStrike)
			{
				if (Projectile.timeLeft % 15 == 0 && Projectile.owner == Main.myPlayer)
				{
					...
					Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, vector63.X, vector63.Y, ModContent.ProjectileType<ShroomerangSpore>(), (int)(Projectile.damage * 0.1), Projectile.knockBack * 0.2f, Projectile.owner, -10f, 0f);
				}
			}
        }
