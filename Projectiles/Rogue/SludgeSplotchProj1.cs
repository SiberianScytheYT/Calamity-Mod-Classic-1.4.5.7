        ...
        public override void OnKill(int timeLeft)
        {
            if (Projectile.Calamity().stealthStrike)
            {
                ...
                for (int i = 0; i < sparkCount; i++)
                {
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, sparkVelocity, ModContent.ProjectileType<SludgeSplotchProj2>(), 7, 0, Projectile.owner, 0, 0);
                }
            }
