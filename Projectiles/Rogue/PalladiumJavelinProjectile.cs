...
namespace CalRD.Projectiles.Rogue
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Rogue/PalladiumJavelin";
        ...
        public override void AI()
        {
			...
			if (Projectile.localAI[0] >= 30f)
			{
				...
				int javelin = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Projectile.velocity.RotatedBy(MathHelper.ToRadians(5f)), Projectile.type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
				int javelin2 = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Projectile.velocity.RotatedBy(MathHelper.ToRadians(-5f)), Projectile.type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Item.NewItem(Entity.GetSource_FromThis(), (int)Projectile.position.X, (int)Projectile.position.Y, Projectile.width, Projectile.height, ModContent.ItemType<PalladiumJavelin>());
            }
        }
    }
}
