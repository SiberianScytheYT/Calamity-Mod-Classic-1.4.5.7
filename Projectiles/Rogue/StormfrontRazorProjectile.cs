...
namespace CalRD.Projectiles.Rogue
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Rogue/StormfrontRazor";
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] >= sparkFreq)
            {
                ...
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, sparkS, ModContent.ProjectileType<Stormfrontspark>(), Projectile.damage, 3f, Projectile.owner);
                Projectile.ai[0] = 0;
            }
