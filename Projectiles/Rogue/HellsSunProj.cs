...
namespace CalRD.Projectiles.Rogue
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Rogue/HellsSun";
            ...
            if (Projectile.ai[0] >= 70f)
            {
				...
				if (Projectile.Calamity().stealthStrike == true)
				{
					if (Projectile.localAI[1] >= 30f)
					{
						...
						Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X - vector2_5.X, Projectile.Center.Y - vector2_5.Y, vector2_5.X, vector2_5.Y, ModContent.ProjectileType<ExplosiveSun>(), Projectile.damage, Projectile.knockBack, Projectile.owner, Main.rand.Next(3), 0.0f);
