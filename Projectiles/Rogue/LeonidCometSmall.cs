...
namespace CalRD.Projectiles.Rogue
{
    public class LeonidCometSmall : ModProjectile
    {
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			Main.spriteBatch.Draw(tex, Projectile.Center - Main.screenPosition, null, CalamityUtils.ColorSwap(LeonidProgenitor.blueColor, LeonidProgenitor.purpleColor, 1f), Projectile.rotation, tex.Size() / 2, Projectile.scale, SpriteEffects.None, 0f);
			return false;
		}
        ...
        public override void OnKill(int timeLeft)
        {
			if (Projectile.owner != Main.myPlayer)
				return;
			Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<LeonidStar>(), Projectile.damage / 3, 0f, Projectile.owner);
			Projectile.ai[1] = -1f;
