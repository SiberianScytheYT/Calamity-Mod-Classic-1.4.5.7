...
namespace CalRD.Projectiles.Rogue
{
    ...
    {
        public override string Texture => "CalRD/Projectiles/Boss/ShadeNimbusHostile";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
			...
			if (Projectile.ai[0] == 1f)
				texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/StealthNimbus2").Value;
            ...
            else
            {
                if (Projectile.timeLeft % 8 == 0)
                {
                    if (Projectile.owner == Main.myPlayer)
                    {
                        ...
                        Projectile.NewProjectile(Entity.GetSource_FromThis(), (float)num414, (float)num415, 0f, 5f, ModContent.ProjectileType<StealthRain>(), Projectile.damage, 0f, Projectile.owner, Projectile.ai[0], 0f);
                    }
                }
            }
