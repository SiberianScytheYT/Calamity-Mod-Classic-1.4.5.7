...
namespace CalRD.Projectiles.Rogue
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Rogue/FrostcrushValari";
        ...
        private void OnHitEffects()
        {
			...
			if (Projectile.owner == Main.myPlayer)
			{
				for (int i = 0; i < icicleAmt; i++)
				{
					...
					int shard = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, velocity, (Main.rand.NextBool(2) ? ModContent.ProjectileType<Valaricicle>() : ModContent.ProjectileType<Valaricicle2>()), Projectile.damage / 3, 0f, Projectile.owner, 0f, 0f);
				}
			}
		}
