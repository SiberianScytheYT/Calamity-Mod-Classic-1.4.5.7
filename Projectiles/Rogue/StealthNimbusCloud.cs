...
namespace CalRD.Projectiles.Rogue
{
    ...
    {
        public override string Texture => "CalRD/Projectiles/Magic/ShadeNimbusCloud";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
			...
			if (Projectile.ai[0] == 1f)
				texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/StealthNimbusCloud2").Value;
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<StealthNimbus>(), Projectile.damage, Projectile.knockBack, Projectile.owner, Projectile.ai[0], 0f);
            }
        }
