...
namespace CalRD.Projectiles.Rogue
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Rogue/ThrowingBrick";
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Item.NewItem(Entity.GetSource_FromThis(), (int)Projectile.position.X, (int)Projectile.position.Y, Projectile.width, Projectile.height, ModContent.ItemType<ThrowingBrick>());
            }
            ...
            if (Projectile.ai[0] == 1)
            {
                ...
                while (split < 3)
                {
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.position.X + shardspeedX, Projectile.position.Y + shardspeedY, shardspeedX, shardspeedY, ModContent.ProjectileType<BrickFragment>(), (int)(Projectile.damage * 0.3), Projectile.knockBack / 2f, Projectile.owner);
                    split += 1;
                }
            }
        }
