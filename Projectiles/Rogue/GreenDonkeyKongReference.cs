...
namespace CalRD.Projectiles.Rogue
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Rogue/AcidicRainBarrel";
        ...
        public void BounceEffects()
        {
            ...
            for (int i = 0; i < projectileCount; i++)
            {
                if (Main.rand.NextBool(3))
                {
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Projectile.velocity + shrapnelVelocity,
                ...
                else
                {
                    ...
                    int acidIndex = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Projectile.velocity + acidVelocity,
