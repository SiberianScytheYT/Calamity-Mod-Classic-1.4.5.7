	...
	public class MetalShard : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            switch (Projectile.localAI[1])
            {
                ...
                case 2f: texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/MetalShard2").Value;
                         break;
                case 3f: texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/MetalShard3").Value;
                         break;
                default: texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/MetalShard").Value;
                         break;
            }
