...
namespace CalRD.Projectiles.Rogue
{
    public class SealedSingularityGore : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                case 1f: texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/SealedSingularityGore2").Value;
                         break;
                case 2f: texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/SealedSingularityGore3").Value;
                         break;
