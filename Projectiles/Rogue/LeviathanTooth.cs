	...
	public class LeviathanTooth : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
			...
			if (Projectile.Calamity().lineColor == 1)
				tex = ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/LeviathanTooth2").Value;
			if (Projectile.Calamity().lineColor == 2)
				tex = ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/LeviathanTooth3").Value;
