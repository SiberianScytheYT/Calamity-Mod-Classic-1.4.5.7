...
namespace CalRD.Projectiles.Rogue
{
    public class FinalDawnHorizontalSlash : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] >= 4)
            {
                ...
                if (Projectile.ai[1] == 3)
                {
                    ...
                    {
                        Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<FinalDawnFlame>(), Projectile.damage / 2, 0f, Projectile.owner);
                    }
                }
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D scytheGlowTexture = ModContent.Request<Texture2D>("CalRD/Projectiles/Rogue/FinalDawnHorizontalSlash_Glow").Value;
