...
namespace CalRD.Projectiles.Rogue
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Rogue/TotalityBreakers";
        ...
        public override void AI()
        {
            if (Projectile.Calamity().stealthStrike)
            {
				if (Projectile.timeLeft % 10 == 0)
				{
					...
					{
						Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<TotalityTar>(), (int)(Projectile.damage * 0.6), Projectile.knockBack, Projectile.owner, 0f, 0f);
					}
				}
            }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            int meltdown = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<TotalMeltdown>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
			...
			for (int t = 0; t < tarAmt; t++)
			{
				...
				Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, velocity, ModContent.ProjectileType<TotalityTar>(), (int)(Projectile.damage * 0.3), 0f, Main.myPlayer, 0f, 0f);
			}
        }
    }
}
