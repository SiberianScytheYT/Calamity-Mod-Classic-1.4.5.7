...
namespace CalRD.Projectiles.Rogue
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Rogue/Penumbra";
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 360; i += ad)
            {
                ...
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, SoulSpeed, ModContent.ProjectileType<PenumbraSoul>(), (int)(Projectile.damage * dmgMult), 3f, Projectile.owner, 0f, 0f);
            }
            //Dust
