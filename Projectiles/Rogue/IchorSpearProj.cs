...
namespace CalRD.Projectiles.Rogue
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Rogue/IchorSpear";
			...
			if (Projectile.Calamity().stealthStrike)
			{
				if (Projectile.timeLeft % 8 == 0)
				{
					if (Projectile.owner == Main.myPlayer)
					{
						...
						int ichor = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, velocity, Main.rand.NextBool(2) ? ProjectileID.GoldenShowerFriendly : ProjectileID.IchorSplash, (int)(Projectile.damage * 0.5), Projectile.knockBack * 0.5f, Projectile.owner, 0f, 0f);
