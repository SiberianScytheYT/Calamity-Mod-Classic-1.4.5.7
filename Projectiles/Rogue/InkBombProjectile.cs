    ...
    public class InkBombProjectile : ModProjectile
    {
        ...
        private void CreateInk()
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                int inkID = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, Main.rand.NextFloat(-2f, 2f), Main.rand.NextFloat(-2f, 2f), inkType, (int)(22 * player.RogueDamage()), 7, Projectile.owner);
