...
namespace CalRD.Projectiles.DraedonsArsenal
{
    public class HydraulicVoltCrasherProjectile : ModProjectile
    {
        ...
        {
            SoundEngine.PlaySound(new SoundStyle("CalRD/Sounds/Item/PlasmaBolt"), target.Center);
            if (chargeCooldown > 0)
                return;
            chargeCooldown = 60;
        ...
        public bool TryToSuperchargeNPC(NPC npc)
        {
            ...
            Projectile.NewProjectile(Entity.GetSource_FromThis(), npc.Center,
                                           Vector2.Zero,
		...
		public override bool PreDraw(ref Color lightColor)
		{
            ...
            Main.EntitySpriteDraw(texture, Projectile.Center - Main.screenPosition + new Vector2(0f, Projectile.gfxOffY), new Microsoft.Xna.Framework.Rectangle?(new Rectangle(0, frameHeight, texture.Width, height)), lightColor, Projectile.rotation, new Vector2(texture.Width / 2f, height / 2f), Projectile.scale, spriteEffects, 0f);
			return false;
		}
    }
}
