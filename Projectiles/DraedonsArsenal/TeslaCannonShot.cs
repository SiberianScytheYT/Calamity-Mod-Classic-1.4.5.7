					...
					if (Projectile.ai[1] == 0f && Main.myPlayer == Projectile.owner)
					{
						if (arcs < 10)
						{
							...
							for (int i = 0; i < Main.maxNPCs; i++)
							{
								...
								{
									Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Projectile.DirectionTo(Main.npc[i].Center) * 2f, Projectile.type, (int)(Projectile.damage * 0.6), Projectile.knockBack * 0.6f, Projectile.owner, 0f, -1f);
