...
namespace CalRD.Projectiles.DraedonsArsenal
{
    public class TaserHook : ModProjectile
    {
        ...
        public void ManipulatePlayerItemValues(Player player)
        {
            ...
            player.itemRotation = Projectile.rotation + (player.direction == -1).ToInt() * MathHelper.Pi;
            player.itemTime = 4;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(texture, Projectile.Center - Main.screenPosition, null, lightColor, Projectile.rotation, texture.Size() * 0.5f, Projectile.scale, SpriteEffects.None, 0f);
            return false;
        }
