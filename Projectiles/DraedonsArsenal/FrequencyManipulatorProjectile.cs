...
namespace CalRD.Projectiles.DraedonsArsenal
{
	...
	{
        public override string Texture => "CalRD/Items/Weapons/DraedonsArsenal/FrequencyManipulator";
		...
		public void OnHitEffects()
		{
			...
			for (int i = 0; i < totalEnergyParticlesToSpawn; i++)
			{
				...
				Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center + velocity * 1.8f, velocity, ModContent.ProjectileType<FrequencyManipulatorEnergy>(), Projectile.damage, Projectile.knockBack * 0.4f, Projectile.owner);
			}
		}
