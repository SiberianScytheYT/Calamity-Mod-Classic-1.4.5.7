    ...
    public class SnakeEyesSummon : ModProjectile
    {
        ...
        public void NPCMovement(NPC npc)
        {
            ...
            if (Time % 20f == 0f)
            {
                ...
                {
                    Projectile laser = Projectile.NewProjectileDirect(Entity.GetSource_FromThis(), Projectile.Center + Utils.Vector2FromElipse(EyeRotation.ToRotationVector2(), Projectile.Size * 0.5f * EyeOutwardness), 
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D eyeTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/SnakeEye").Value;
