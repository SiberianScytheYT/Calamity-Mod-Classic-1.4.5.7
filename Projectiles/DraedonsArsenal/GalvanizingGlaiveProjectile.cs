...
namespace CalRD.Projectiles.DraedonsArsenal
{
    public class GalvanizingGlaiveProjectile : BaseSpearProjectile
    {
        ...
        public override Action<Projectile> EffectBeforeReelback => proj =>
        {
            ...
            Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center + offset, Projectile.velocity.SafeNormalize(Vector2.UnitY) * 15f, ModContent.ProjectileType<GaussEnergy>(), (int)(Projectile.damage * 0.4), 0f, Projectile.owner);
        };
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(texture, drawPosition, null, lightColor, Projectile.rotation, origin, Projectile.scale, Projectile.spriteDirection == -1 ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 0f);
            return false;
        }
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            for (int i = 0; i < oldPositions.Count - 2; i += 2)
            {
                ...
                Utils.DrawLaser(Main.spriteBatch, ModContent.Request<Texture2D>("CalRD/Projectiles/LightningProj").Value, start, end, new Vector2(0.2f), new Utils.LaserLineFraming(DelegateMethods.LightningLaserDraw));
            }
        }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            if (Main.rand.NextBool(12))
                Projectile.NewProjectile(Entity.GetSource_FromThis(), target.Center, Vector2.Zero, ModContent.ProjectileType<GaussFlux>(), Projectile.damage, 0f, Projectile.owner, 0f, target.whoAmI);
        }
    }
}
