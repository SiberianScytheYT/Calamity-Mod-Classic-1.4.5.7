    ...
    public class PulseTurret : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (potentialTarget != null)
            {
                ...
                {
                    Texture2D standTexture = ModContent.Request<Texture2D>("CalRD/Projectiles/DraedonsArsenal/PulseTurretStand").Value;
                    ...
                    {
                        SoundEngine.PlaySound(new SoundStyle("CalRD/Sounds/Item/PulseRifleFire"), shootPosition);
                        Projectile.NewProjectile(Entity.GetSource_FromThis(), shootPosition,
