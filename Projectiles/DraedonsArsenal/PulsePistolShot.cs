...
namespace CalRD.Projectiles.DraedonsArsenal
{
    public class PulsePistolShot : ModProjectile
    {
        ...
        public override bool? CanDamage()/* tModPorter Suggestion: Return null instead of true */ => Time > Projectile.MaxUpdates;
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            Projectile splitShot = Projectile.NewProjectileDirect(Entity.GetSource_FromThis(), Projectile.Center,
                                                                  Projectile.velocity,
                                                                  Projectile.type,
                                                                  Projectile.damage,
