...
namespace CalRD.Projectiles.Pets
{
	public class Sparks : ModProjectile
	{
        ...
        public override bool PreDraw(ref Color lightColor)
        {
			...
			if (color == 1)
				texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Pets/SparksBlue").Value;
			if (color == 2)
				texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Pets/SparksGreen").Value;
