        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(12))
            {
                for (int num43 = 0; num43 < 1; num43++)
                {
                    ...
                    int num44 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 31, 0f, 0f, 100, default, 1f);
            ...
            {
                int num154 = 14;
                int num155 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width - num154 * 2, Projectile.height - num154 * 2, 259, 0f, 0f, 100, default, 1.35f);
            ...
            {
                int num156 = 16;
                int num157 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width - num156 * 2, Projectile.height - num156 * 2, 259, 0f, 0f, 100, default, 1f);
