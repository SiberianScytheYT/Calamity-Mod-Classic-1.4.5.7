...
namespace CalRD.Projectiles.Typeless
{
    public class SabatonSlam : ModProjectile
    {
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
			...
			{
				Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.position.X + 25, Projectile.position.Y + 25, 0f, 0f, ModContent.ProjectileType<SabatonBoom>(), (int)(300 * player.AverageDamage()), 12, Projectile.owner);
