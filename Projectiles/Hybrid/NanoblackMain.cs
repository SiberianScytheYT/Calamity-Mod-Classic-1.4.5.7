...
namespace CalRD.Projectiles.Hybrid
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Rogue/NanoblackReaperRogue";
        ...
        private void SpawnEnergyBlade()
        {
            ...
            {
                int proj = Projectile.NewProjectile(Entity.GetSource_FromThis(), pos, Vector2.Zero, bladeID, bladeDamage, bladeKB, Projectile.owner, 0f, spin);
