...
namespace CalRD.Projectiles.Hybrid
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Melee/StellarContemptMelee";
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            for (int i = 0; i < numFlares; ++i)
            {
                ...
                {
                    int proj = Projectile.NewProjectile(Entity.GetSource_FromThis(), startPoint, velocity, ProjectileID.LunarFlare, flareDamage, flareKB, Main.myPlayer, 0f, AI1);
