            ...
            else
            {
                ...
                if (Projectile.owner == Main.myPlayer)
                {
                    ...
                    for (int num627 = 0; num627 < num626; num627 = num3 + 1)
                    {
                        ...
                        {
                            Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.position.X, Projectile.position.Y, num628, num629, ModContent.ProjectileType<ScourgeoftheCosmosMini>(), (int)((double)Projectile.damage * 0.7), Projectile.knockBack * 0.35f, Main.myPlayer, 0f, 1f);
                        }
                        else
                        {
                            Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.position.X, Projectile.position.Y, num628, num629, ModContent.ProjectileType<ScourgeoftheCosmosMini>(), (int)((double)Projectile.damage * 0.7), Projectile.knockBack * 0.35f, Main.myPlayer, 0f, 0f);
                        }
                        num3 = num627;
                    }
                }
