...
namespace CalRD.Projectiles.Hybrid
{
    public class ScourgeoftheCosmosMini : ModProjectile
    {
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(ModContent.Request<Texture2D>("CalRD/Projectiles/Hybrid/ScourgeoftheCosmosMiniGlow").Value, Projectile.Center - Main.screenPosition, new Microsoft.Xna.Framework.Rectangle?(new Rectangle(0, y6, texture2D13.Width, num214)), Color.White, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0f);
        }
    }
}
