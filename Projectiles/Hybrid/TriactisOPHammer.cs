...
namespace CalRD.Projectiles.Hybrid
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Melee/TriactisTruePaladinianMageHammerofMightMelee";
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<MageHammerBoom>(), (int)((double)Projectile.damage * 0.25), Projectile.knockBack, Projectile.owner, 0f, 0f);
            }
