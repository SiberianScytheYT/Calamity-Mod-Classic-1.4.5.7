...
namespace CalRD.Projectiles
{
    public class CalamityGlobalProjectile : GlobalProjectile
    {
            ...
            if (CalamityWorld.revenge || BossRushEvent.BossRushActive)
            {
                ...
                else if (projectile.type == ProjectileID.Cthulunado)
                {
                    ...
                    if (projectile.ai[0] == 1f && projectile.ai[1] > 0f && projectile.owner == Main.myPlayer)
                    {
                        ...
                        {
                            int num614 = NPC.NewNPC(projectile.GetSource_FromThis(), (int)center.X, (int)center.Y, NPCID.Sharkron2, 0, 0f, 0f, 0f, 0f, 255);
            ...
            if (CalamityWorld.death && !CalamityPlayer.areThereAnyDamnBosses)
            {
                if (projectile.type == ProjectileID.Sharknado || projectile.type == ProjectileID.Cthulunado)
                {
                    ...
                    if (projectile.ai[0] == 1f && projectile.ai[1] > 0f && projectile.owner == Main.myPlayer)
                    {
                        ...
                        center2.Y += 2f;
                        Projectile.NewProjectile(projectile.GetSource_FromThis(), center2, projectile.velocity, projectile.type, projectile.damage, projectile.knockBack, projectile.owner, 10f, projectile.ai[1] - 1f);
                    }
                    if (projectile.ai[0] <= 0f)
                    {
        ...
        public override void AI(Projectile projectile)
        {
            ...
            if (projectile.ModProjectile != null && projectile.ModProjectile.Mod.Name.Equals("CalRD"))
                goto SKIP_CALAMITY;
            ...
            {
                if (modPlayer.eQuiver && projectile.CountsAsClass(DamageClass.Ranged) && CalamityLists.rangedProjectileExceptionList.TrueForAll(x => projectile.type != x))
                {
                    if (Main.player[projectile.owner].miscCounter % 60 == 0 && projectile.FinalExtraUpdate())
                    {
                        ...
                        {
                            int projectile1 = Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center.X, projectile.Center.Y, (float)(Math.Sin(startAngle) * 8f), (float)(Math.Cos(startAngle) * 8f), projectile.type, CalamityUtils.DamageSoftCap(projectile.damage * 0.15, 150), projectile.knockBack, projectile.owner, 0f, 0f);
                            int projectile2 = Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center.X, projectile.Center.Y, (float)(-Math.Sin(startAngle) * 8f), (float)(-Math.Cos(startAngle) * 8f), projectile.type, CalamityUtils.DamageSoftCap(projectile.damage * 0.15, 150), projectile.knockBack, projectile.owner, 0f, 0f);
                    ...
                    if (Main.player[projectile.owner].miscCounter % 6 == 0 && projectile.FinalExtraUpdate())
                    {
                        if (projectile.owner == Main.myPlayer && player.ownedProjectileCounts[ProjectileID.Mushroom] < 30)
                        {
                                ...
                                projectile.type == ProjectileType<MourningstarFlail>() || projectile.type == ProjectileID.SolarWhipSword)
                            {
                                ...
                                Projectile.NewProjectile(projectile.GetSource_FromThis(), newCenter.X, newCenter.Y, 0f, 0f, ProjectileID.Mushroom,
                                    CalamityUtils.DamageSoftCap(projectile.damage * 0.25, 100), 0f, projectile.owner, 0f, 0f);
                            }
                            else
                            {
                                Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, Vector2.Zero, ProjectileID.Mushroom,
                                    CalamityUtils.DamageSoftCap(projectile.damage * 0.25, 100), 0f, projectile.owner, 0f, 0f);
                            }
                        }
                    }
                ...
                if (rogue)
                {
                    if (modPlayer.nanotech && rogue && projectile.type != ProjectileType<MoonSigil>() && projectile.type != ProjectileType<DragonShit>())
                    {
                        if (Main.player[projectile.owner].miscCounter % 30 == 0 && projectile.FinalExtraUpdate())
                        {
                            ...
                            {
                                Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, Vector2.Zero, ProjectileType<Nanotech>(),
                    ...
                    else if (modPlayer.moonCrown)
                    {
                        ...
                        {
                            Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, Vector2.Zero, ProjectileType<MoonSigil>(), CalamityUtils.DamageSoftCap(projectile.damage * 0.2, 75), 0, projectile.owner);
                        }
                    }
                    if (modPlayer.dragonScales && projectile.type != ProjectileType<MoonSigil>() && projectile.type != ProjectileType<DragonShit>())
                    {
                        if (Main.player[projectile.owner].miscCounter % 50 == 0 && projectile.FinalExtraUpdate())
                        {
                            if (projectile.owner == Main.myPlayer && player.ownedProjectileCounts[ProjectileType<DragonShit>()] < 15)
                            {
                                ...
                                Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, Vector2.One.RotatedByRandom(MathHelper.TwoPi), ProjectileType<DragonShit>(),
                        ...
                        if (Main.player[projectile.owner].miscCounter % 30 == 0 && projectile.FinalExtraUpdate())
                        {
                            if (projectile.owner == Main.myPlayer && player.ownedProjectileCounts[ProjectileID.CrystalShard] < 30)
                            {
                                for (int i = 0; i < 2; i++)
                                {
                                    ...
                                    int shard = Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, velocity, ProjectileID.CrystalShard, CalamityUtils.DamageSoftCap(projectile.damage * 0.25, 30), 0f, projectile.owner, 0f, 0f);
                ...
                if (modPlayer.providenceLore && projectile.owner == Main.myPlayer && projectile.damage > 0 &&
                    (projectile.CountsAsClass(DamageClass.Melee) || projectile.CountsAsClass(DamageClass.Ranged) || projectile.CountsAsClass(DamageClass.Magic) || projectile.CountsAsClass(DamageClass.Throwing) || rogue))
                {
                    if (Main.rand.NextBool(5))
                    {
                ...
                if (!projectile.CountsAsClass(DamageClass.Melee) && player.meleeEnchant > 0 && !projectile.noEnchantments)
                {
                    if (player.meleeEnchant == 7) //flask of party affects all types of weapons
                    {
                        ...
                        if (Main.rand.NextBool(40))
                        {
                            ...
                            int index = Gore.NewGore(projectile.GetSource_FromThis(), projectile.position, velocity, Type, 1f);
        ...
        public override void OnHitNPC(Projectile projectile, NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (projectile.owner == Main.myPlayer && !projectile.npcProj && !projectile.trap && projectile.friendly)
            {
                ...
                if (!projectile.CountsAsClass(DamageClass.Melee) && player.meleeEnchant == 7)
                    Projectile.NewProjectile(projectile.GetSource_FromThis(), target.Center, target.velocity, ProjectileID.ConfettiMelee, 0, 0f, projectile.owner, 0f, 0f);
                ...
                if (rogue && stealthStrike && modPlayer.dragonScales && CalamityUtils.CountProjectiles(ProjectileType<InfernadoFriendly>()) < 2)
                {
                    ...
                    int projectileIndex = Projectile.NewProjectile(projectile.GetSource_FromThis(), projTileX * 16 + 8, projTileY * 16 - 24, 0f, 0f, ProjectileType<InfernadoFriendly>(), 420, 15f, Main.myPlayer, 16f, 16f);
                ...
                if (!target.canGhostHeal)
                {
                    if (player.ghostHurt)
                    {
                        projectile.ghostHurt(hit.Damage, target.Center, target);
                    }
                    ...
                    if (player.setNebula && player.nebulaCD == 0 && Main.rand.Next(3) == 0)
                    {
                        ...
                        int nebulaBooster = Item.NewItem(target.GetSource_FromThis(), target.Center, target.Size, boosterType, 1, false, 0, false, false);
                ...
                if (Main.player[Main.myPlayer].lifeSteal > 0f && target.canGhostHeal && target.type != NPCID.TargetDummy && target.type != NPCType<SuperDummyNPC>() && !player.moonLeech)
                {
                    ...
                    if (player.ghostHeal)
                    {
                        ...
                        float cooldown = projectile.damage * cooldownMult;
                    ...
                    {
                        float cooldown = projectile.damage * 0.075f;
                        if (cooldown < 0f)
                            cooldown = 0f;
                    ...
                    if (modPlayer.vampiricTalisman && rogue && hit.Crit)
                    {
                        float heal = MathHelper.Clamp(projectile.damage * 0.015f, 0f, 6f);
                        if ((int)heal > 0)
                        {
                    ...
                    if (projectile.CountsAsClass(DamageClass.Magic) && player.ActiveItem().CountsAsClass(DamageClass.Magic))
                    {
                    ...
                    else if (projectile.CountsAsClass(DamageClass.Magic) && player.ActiveItem().CountsAsClass(DamageClass.Magic))
                    {
                ...
                if (modPlayer.alchFlask &&
                    (projectile.CountsAsClass(DamageClass.Magic) || rogue || projectile.CountsAsClass(DamageClass.Melee) || projectile.IsSummon() || projectile.CountsAsClass(DamageClass.Ranged)) &&
                    player.ownedProjectileCounts[ProjectileType<PlagueSeeker>()] < 6)
                {
                    int plague = Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, Vector2.Zero, ProjectileType<PlagueSeeker>(), CalamityUtils.DamageSoftCap(projectile.damage * 0.25, 30), 0f, projectile.owner, 0f, 0f);
                    Main.projectile[plague].Calamity().forceTypeless = true;
                }

                if (modPlayer.reaverBlast && projectile.CountsAsClass(DamageClass.Melee))
                {
                    Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, Vector2.Zero, ProjectileType<ReaverBlast>(), CalamityUtils.DamageSoftCap(projectile.damage * 0.2, 30), 0f, projectile.owner, 0f, 0f);
                }
                ...
                if (projectile.CountsAsClass(DamageClass.Magic))
                {
                    ...
                    if (modPlayer.reaverBurst)
                    {
                        ...
                        {
                            Vector2 velocity = CalamityUtils.RandomVelocity(100f, 70f, 100f);
                            int proj = Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, velocity, ProjectileID.SporeGas + Main.rand.Next(3), CalamityUtils.DamageSoftCap(projectile.damage * 0.15, 25), 0f, projectile.owner, 0f, 0f);
                ...
                if (projectile.CountsAsClass(DamageClass.Melee))
                {
                    ...
                    {
                        Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, Vector2.Zero, ProjectileType<ChaosGeyser>(), CalamityUtils.DamageSoftCap(projectile.damage * 0.15, 35), 0f, projectile.owner, 0f, 0f);
                    }
                }
                if (rogue)
                {
                    if (modPlayer.xerocSet && modPlayer.xerocDmg <= 0 && player.ownedProjectileCounts[ProjectileType<XerocFire>()] < 3 && player.ownedProjectileCounts[ProjectileType<XerocBlast>()] < 3)
                    {
                        switch (Main.rand.Next(5))
                        {
                            ...
                            case 2:
                                ...
                                Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, Vector2.Zero, ProjectileType<XerocFire>(), CalamityUtils.DamageSoftCap(projectile.damage * 0.15, 30), 0f, projectile.owner, 0f, 0f);

                                break;

                            case 3:

                                Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, Vector2.Zero, ProjectileType<XerocBlast>(), CalamityUtils.DamageSoftCap(projectile.damage * 0.2, 40), 0f, projectile.owner, 0f, 0f);
                    ...
                    if (modPlayer.featherCrown && stealthStrike && modPlayer.featherCrownCooldown <= 0 && stealthStrikeHitCount < 5)
                    {
                        for (int i = 0; i < 6; i++)
                        {
                            ...
                            int feather = Projectile.NewProjectile(projectile.GetSource_FromThis(), source, velocity, ProjectileType<StickyFeather>(), dmg, 3f, projectile.owner);
                    ...
                    if (modPlayer.moonCrown && stealthStrike && modPlayer.moonCrownCooldown <= 0 && stealthStrikeHitCount < 5)
                    {
                        for (int i = 0; i < 6; i++)
                        {
                            ...
                            int flare = Projectile.NewProjectile(projectile.GetSource_FromThis(), source, velocity, ProjectileID.LunarFlare, dmg, 3, projectile.owner);
                    ...
                    if (modPlayer.nanotech && stealthStrike && modPlayer.nanoFlareCooldown <= 0 && stealthStrikeHitCount < 5)
                    {
                        for (int i = 0; i < 6; i++)
                        {
                            ...
                            int flare = Projectile.NewProjectile(projectile.GetSource_FromThis(), source, velocity, ProjectileType<NanoFlare>(),dmg, 3f, projectile.owner);
                    ...
                    if (modPlayer.forbiddenCirclet && stealthStrike && modPlayer.forbiddenCooldown <= 0 && stealthStrikeHitCount < 5)
                    {
                        for (int index2 = 0; index2 < 6; index2++)
                        {
                            ...
                            Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center.X, projectile.Center.Y, xVector, yVector, ProjectileType<ForbiddenCircletEater>(), dmg, projectile.knockBack, projectile.owner, 0f, 0f);
                    ...
                    if (modPlayer.titanHeartSet && stealthStrike && modPlayer.titanCooldown <= 0 && stealthStrikeHitCount < 5)
                    {
                        ...
                        int boom = Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, Vector2.Zero, ProjectileType<SabatonBoom>(), dmg, projectile.knockBack, projectile.owner, 0f, 0f);
                        ...
                        for (int i = 0; i < 3; i++)
                        {
                            if (Main.rand.NextBool(2))
                            {
                                ...
                                if (type != -1)
                                {
                                    ...
                                    Projectile.NewProjectile(projectile.GetSource_FromThis(), target.Center, Vector2.One.RotatedByRandom(MathHelper.TwoPi) * speed,
                    ...
                    if (modPlayer.shadow && modPlayer.shadowPotCooldown <= 0 && stealthStrikeHitCount < 5)
                    {
                        if (CalamityLists.javelinProjList.Contains(projectile.type))
                        {
                            ...
                            Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, SoulSpeed, ProjectileType<PenumbraSoul>(), CalamityUtils.DamageSoftCap(projectile.damage * 0.1, 60), 3f, projectile.owner, 0f, 0f);
                            modPlayer.shadowPotCooldown = 30;
                        }
                        if (CalamityLists.spikyBallProjList.Contains(projectile.type))
                        {
                            int scythe = Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, Vector2.Zero, ProjectileType<CosmicScythe>(), CalamityUtils.DamageSoftCap(projectile.damage * 0.05, 60), 3f, projectile.owner, 1f, 0f);
                        ...
                        if (CalamityLists.daggerProjList.Contains(projectile.type))
                        {
                            ...
                            shardVelocity *= 5f;
                            int shard = Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, shardVelocity, ProjectileType<EquanimityDarkShard>(), CalamityUtils.DamageSoftCap(projectile.damage * 0.15, 60), 0f, projectile.owner);
                        ...
                        {
                            int blackhole = Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, Vector2.Zero, ProjectileType<ShadowBlackhole>(), CalamityUtils.DamageSoftCap(projectile.damage * 0.05, 60), 3f, projectile.owner, 0f, 0f);
                    ...
                    if (summonExceptionList.TrueForAll(x => projectile.type != x))
                    {
                        if (modPlayer.jellyDmg <= 0)
                        {
                            if (modPlayer.nucleogenesis)
                            {
                                if (Main.rand.NextBool(4))
                                {
                                    Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, Vector2.Zero, ProjectileType<ApparatusExplosion>(), CalamityUtils.DamageSoftCap(projectile.damage * 0.25, 90), projectile.knockBack * 0.25f, projectile.owner);
                            ...
                            else if (modPlayer.starbusterCore)
                            {
                                if (Main.rand.NextBool(3))
                                {
                                    ...
                                    Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, Vector2.Zero, ProjectileType<SummonAstralExplosion>(),
                            ...
                            else if (modPlayer.nuclearRod)
                            {
                                if (Main.rand.NextBool(3))
                                {
                                    Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, Vector2.Zero, ProjectileType<IrradiatedAura>(),
                        ...
                        if (modPlayer.hallowedPower)
                        {
                            if (Main.rand.NextBool(3) && modPlayer.hallowedRuneCooldown <= 0)
                            {
                                ...
                                Projectile.NewProjectile(projectile.GetSource_FromThis(), spawnPosition, Vector2.Normalize(target.Center - spawnPosition) * speed,
                ...
                if (projectile.CountsAsClass(DamageClass.Ranged))
                {
                    if (modPlayer.tarraRanged && Main.rand.Next(0, 100) >= 88 && player.ownedProjectileCounts[ProjectileType<TarraEnergy>()] <= 20 && (projectile.timeLeft <= 2 || projectile.penetrate <= 1))
                    {
                        ...
                        {
                            Vector2 velocity = CalamityUtils.RandomVelocity(100f, 70f, 100f);
                            Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, velocity, ProjectileType<TarraEnergy>(), CalamityUtils.DamageSoftCap(projectile.damage * 0.33, 65), 0f, projectile.owner, 0f, 0f);
                        }
                    }
                }
            }
        ...
        public override void OnKill(Projectile projectile, int timeLeft)
        {
            ...
            {
                if (modPlayer.providenceLore && projectile.friendly && projectile.damage > 0 && (projectile.CountsAsClass(DamageClass.Melee) || projectile.CountsAsClass(DamageClass.Ranged) || projectile.CountsAsClass(DamageClass.Magic) || rogue))
                {
                ...
                if (rogue)
                {
                    if (modPlayer.etherealExtorter && Main.rand.Next(0, 100) >= 95)
                    {
                        ...
                        {
                            Vector2 velocity = CalamityUtils.RandomVelocity(100f, 70f, 100f);
                            int soul = Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, velocity, ProjectileType<LostSoulFriendly>(), CalamityUtils.DamageSoftCap(projectile.damage * 0.33, 50), 0f, projectile.owner, 0f, 0f);
                    ...
                    if (modPlayer.scuttlersJewel && CalamityLists.javelinProjList.Contains(projectile.type) && Main.rand.NextBool(3))
                    {
                        ...
                        int spike = Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, Vector2.Zero, ProjectileType<JewelSpike>(), CalamityUtils.DamageSoftCap(projectile.damage * 0.5 * dmgMult, 50), projectile.knockBack, projectile.owner);
                ...
                if (projectile.localAI[0] > projectileTimer)
                {
                    ...
                    if (attackMultiple)
                    {
                        for (int i = 0; i < targetArrayIndex; i++)
                        {
                            ...
                            {
                                int projectile2 = Projectile.NewProjectile(projectile.GetSource_FromThis(), value.X, value.Y, velocity.X, velocity.Y, spawnedProjectile, (int)(projectile.damage * damageMult), projectile.knockBack, projectile.owner, 0f, 0f);
