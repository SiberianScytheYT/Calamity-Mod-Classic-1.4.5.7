...
namespace CalRD.Projectiles.BaseProjectiles
{
    public abstract class BaseSpearProjectile : ModProjectile
    {
        ...
        {
            Main.EntitySpriteDraw(ModContent.Request<Texture2D>(Texture).Value, Projectile.Center - Main.screenPosition, null, Projectile.GetAlpha(lightColor), Projectile.rotation, Vector2.Zero, Projectile.scale, 0, 0);
            return false;
        }
