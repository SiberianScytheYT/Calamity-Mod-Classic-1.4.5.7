...
namespace CalRD.Projectiles.Boss
{
    public class DoGDeath : ModProjectile
    {
        ...
        public override bool? CanDamage()/* tModPorter Suggestion: Return null instead of true */ => TelegraphDelay > TelegraphTotalTime;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            if (TelegraphDelay >= TelegraphTotalTime)
                return true;
            Texture2D laserTelegraph = ModContent.Request<Texture2D>("CalRD/ExtraTextures/LaserWallTelegraphBeam").Value;
            float yScale = 2f;
            ...
            Main.EntitySpriteDraw(laserTelegraph, Projectile.Center - Main.screenPosition, null, colorInner, OldVelocity.ToRotation(), origin, scaleInner, SpriteEffects.None, 0f);
            Main.EntitySpriteDraw(laserTelegraph, Projectile.Center - Main.screenPosition, null, colorOuter, OldVelocity.ToRotation(), origin, scaleOuter, SpriteEffects.None, 0f);
            return false;
        }
    }
}
