...
namespace CalRD.Projectiles.Boss
{
    ...
    {
        public override string Texture => "CalRD/Projectiles/Boss/SkyFlare";
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                int num235 = 100;
                int num236 = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<InfernadoRevenge>(), num235, 4f, Main.myPlayer, 16f, 50f);
