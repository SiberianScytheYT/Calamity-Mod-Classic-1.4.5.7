...
namespace CalRD.Projectiles.Boss
{
    public class MoltenBlast : ModProjectile
    {
        ...
        {
            Texture2D texture2D13 = Main.dayTime ? TextureAssets.Projectile[Projectile.type].Value : ModContent.Request<Texture2D>("CalRD/Projectiles/Boss/MoltenBlastNight").Value;
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                for (int b = 0; b < blobAmt; b++)
                {
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, velocity, ModContent.ProjectileType<MoltenBlob>(), Projectile.damage, 0f, Projectile.owner, 0f, 0f);
                }
            }
