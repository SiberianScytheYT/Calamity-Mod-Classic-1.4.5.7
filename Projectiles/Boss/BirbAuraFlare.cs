        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
				...
				if (Projectile.ai[0] >= 2f)
				{
					...
					int num237 = Projectile.NewProjectile(Entity.GetSource_FromThis(), x, y, 0f, laserVelocity.Y, type, damage, 0f, Main.myPlayer, x, y);
					...
					laserVelocity = new Vector2(x, 160f) - new Vector2(x, y);
					laserVelocity.Normalize();
					int num238 = Projectile.NewProjectile(Entity.GetSource_FromThis(), x, y, 0f, laserVelocity.Y, type, damage, 0f, Main.myPlayer, x, y);
				...
				{
					laserVelocity.Normalize();
					int num236 = Projectile.NewProjectile(Entity.GetSource_FromThis(), x, y, 0f, laserVelocity.Y, type, damage, 0f, Main.myPlayer, x, y);
