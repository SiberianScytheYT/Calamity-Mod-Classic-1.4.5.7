...
namespace CalRD.Projectiles.Boss
{
    public class PlagueStingerGoliath : ModProjectile
    {
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Vector2 vector11 = new Vector2(TextureAssets.Projectile[Projectile.type].Value.Width / 2, TextureAssets.Projectile[Projectile.type].Value.Height / Main.projFrames[Projectile.type] / 2);
            Vector2 vector = center - Main.screenPosition;
            vector -= new Vector2(ModContent.Request<Texture2D>("CalRD/Projectiles/Boss/PlagueStingerGoliathGlow").Value.Width, ModContent.Request<Texture2D>("CalRD/Projectiles/Boss/PlagueStingerGoliathGlow").Value.Height / Main.projFrames[Projectile.type]) * 1f / 2f;
            ...
            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalRD/Projectiles/Boss/PlagueStingerGoliathGlow").Value, vector,
