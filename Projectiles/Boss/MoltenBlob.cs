...
namespace CalRD.Projectiles.Boss
{
    public class MoltenBlob : ModProjectile
    {
		...
		{
			Texture2D texture2D13 = Main.dayTime ? TextureAssets.Projectile[Projectile.type].Value : ModContent.Request<Texture2D>("CalRD/Projectiles/Boss/MoltenBlobNight").Value;
