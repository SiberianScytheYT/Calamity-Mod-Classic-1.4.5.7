        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                if (Projectile.ai[0] >= 45f)
                {
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), (float)num414, (float)num415, 0f, 4f, ModContent.ProjectileType<ShaderainHostile>(), Projectile.damage, 0f, Main.myPlayer, 0f, 0f);
                }
            }
        }
    }
