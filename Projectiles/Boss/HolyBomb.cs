    ...
    public class HolyBomb : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (flareShootTimer <= 0)
            {
                ...
                {
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, -2f, ModContent.ProjectileType<HolyFlare>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
                }
                flareShootTimer = 60;
            }
        ...
        {
            Texture2D texture2D13 = Main.dayTime ? TextureAssets.Projectile[Projectile.type].Value : ModContent.Request<Texture2D>("CalRD/Projectiles/Boss/HolyBombNight").Value;
