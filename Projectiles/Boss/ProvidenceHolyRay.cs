...
namespace CalRD.Projectiles.Boss
{
    public class ProvidenceHolyRay : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture2D19 = Main.dayTime ? TextureAssets.Projectile[Projectile.type].Value : ModContent.Request<Texture2D>("CalRD/Projectiles/Boss/ProvidenceHolyRayNight").Value;
            Texture2D texture2D20 = Main.dayTime ? ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/ProvidenceHolyRayMid").Value : ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/ProvidenceHolyRayMidNight").Value;
            Texture2D texture2D21 = Main.dayTime ? ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/ProvidenceHolyRayEnd").Value : ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/ProvidenceHolyRayEndNight").Value;
