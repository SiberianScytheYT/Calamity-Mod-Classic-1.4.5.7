...
namespace CalRD.Projectiles.Boss
{
    ...
    {
        public override string Texture => "CalRD/Projectiles/Boss/Flarenado";
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] == 1f && Projectile.ai[1] > 0f && Projectile.owner == Main.myPlayer)
            {
                ...
                center.Y += 2f;
                Projectile.NewProjectile(Entity.GetSource_FromThis(), center, Projectile.velocity, Projectile.type, Projectile.damage, Projectile.knockBack, Projectile.owner, 11f, Projectile.ai[1] - 1f);
            }
            if (Projectile.ai[0] <= 0f)
            {
