    ...
    public class CrescentMoonFlail : BaseWhipProjectile
    {
        ...
        public override void ExtraBehavior()
        {
            ...
            if (moonCounter <= 0 && Projectile.owner == Main.myPlayer)
            {
                ...
                Projectile.NewProjectile(Entity.GetSource_FromThis(), newCenter.X, newCenter.Y, 0f, 0f, ModContent.ProjectileType<CrescentMoonProj>(), moonDamage, 0f, Projectile.owner, 0f, 0f);
                moonCounter = 6;
            }
        }
