    ...
    public class TyphonsGreedStaff : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.localAI[0] % 12f == 0f)
            {
                ...
                {
					Projectile bubble = CalamityUtils.ProjectileBarrage(Projectile.GetSource_FromThis(), Projectile.Center, player.Center, Main.rand.NextBool(), 800f, 800f, 0f, 800f, 10f, ModContent.ProjectileType<TyphonsGreedBubble>(), (int)(Projectile.damage * 0.5), Projectile.knockBack * 0.5f, Projectile.owner, true);
