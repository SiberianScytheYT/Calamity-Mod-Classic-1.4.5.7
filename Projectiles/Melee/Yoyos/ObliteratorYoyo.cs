	...
	public class ObliteratorYoyo : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if(Projectile.localAI[1] % FramesPerShot == 0f)
            {
                ...
                {
                    int proj = Projectile.NewProjectile(Entity.GetSource_FromThis(), laserSpawnPosition, velocity, ModContent.ProjectileType<NebulaShot>(), laserDamage, laserKB, Projectile.owner);
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalRD/Projectiles/Melee/Yoyos/ObliteratorYoyoGlow").Value, Projectile.Center - Main.screenPosition, null, Color.White, Projectile.rotation, origin, 2f, SpriteEffects.None, 0f);
        }
