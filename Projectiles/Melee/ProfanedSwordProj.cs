...
namespace CalRD.Projectiles.Melee
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Melee/ProfanedSword";
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
			...
			if (Main.myPlayer == Projectile.owner)
			{
				if (explosionCount < 3)
				{
					Projectile.NewProjectile(Entity.GetSource_FromThis(), target.Center.X, target.Center.Y, 0f, 0f, ModContent.ProjectileType<BrimstoneSwordExplosion>(), (int)(Projectile.damage * 0.5), Projectile.knockBack, Projectile.owner);
					explosionCount++;
				}
			}
