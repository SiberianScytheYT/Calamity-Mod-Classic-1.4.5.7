...
namespace CalRD.Projectiles.Melee
{
	public class TemporalFloeSwordProjectile : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
			...
			Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, hourVector, projType, dmg, kback, Projectile.owner, 0f, 0f);
			Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, minuteVector, projType, dmg, kback, Projectile.owner, 0f, 0f);
        }
