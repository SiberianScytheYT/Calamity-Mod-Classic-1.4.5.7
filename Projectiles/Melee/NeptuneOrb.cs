...
namespace CalRD.Projectiles.Melee
{
    ...
    {
        public override string Texture => "CalRD/Projectiles/Melee/DepthOrb";
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft % 20 == 19)
            {
                ...
                {
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 15f, ModContent.ProjectileType<DepthOrb2>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
                }
            }
