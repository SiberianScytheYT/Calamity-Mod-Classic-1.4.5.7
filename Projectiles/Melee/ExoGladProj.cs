		...
		*/
		...
		private void OnHitEffects(Vector2 targetPos)
		{
			...
			if (Projectile.owner == Main.myPlayer)
			{
				...
				{
					CalamityUtils.ProjectileBarrage(Projectile.GetSource_FromThis(), Projectile.Center, targetPos, Main.rand.NextBool(), 1000f, 1400f, 80f, 900f, Main.rand.NextFloat(24f, 30f), ModContent.ProjectileType<ExoGladiusBeam>(), swordDmg, swordKB, Projectile.owner);
				}

				for (int n = 0; n < spearAmt; n++)
				{
					CalamityUtils.ProjectileRain(Projectile.GetSource_FromThis(), targetPos, 400f, 100f, -1000f, -800f, 29f, ModContent.ProjectileType<ExoGladSpears>(), swordDmg, swordKB, Projectile.owner);
				}
			}
        }
    }
