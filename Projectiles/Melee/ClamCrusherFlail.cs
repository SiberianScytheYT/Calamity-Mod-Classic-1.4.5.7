	...
	public class ClamCrusherFlail : ModProjectile
    {
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            if (Projectile.ai[1] >= 5f)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("CalRD/Sounds/Item/ClamImpact"), Projectile.position);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture2D2 = ModContent.Request<Texture2D>("CalRD/ExtraTextures/Chains/ClamCrusherChain").Value;
