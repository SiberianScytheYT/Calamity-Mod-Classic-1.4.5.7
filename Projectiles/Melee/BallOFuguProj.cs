    ...
    public class BallOFuguProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[1] % 4f == 0f && Projectile.owner == Main.myPlayer)
            {
                ...
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, vector63.X, vector63.Y, ModContent.ProjectileType<UrchinSpikeFugu>(), (int)(Projectile.damage * 0.6), Projectile.knockBack * 0.2f, Projectile.owner, -10f, 0f);
            }
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture2D2 = ModContent.Request<Texture2D>("CalRD/ExtraTextures/Chains/BallOFuguChain").Value;
