    ...
    public class VoidEssence : ModProjectile
    {
        ...
        private void SpawnTentacle(Vector2 tentacleVelocity)
        {
            ...
            if (Projectile.owner == Main.myPlayer)
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, tentacleVelocity, ModContent.ProjectileType<VoidTentacle>(), damage, kb, Projectile.owner, ai0, ai1);
        }
    }
}
