            ...
            else
            {
                ...
                if (Projectile.ai[0] > 6f)
                {
                    ...
                    if (Projectile.owner == Main.myPlayer)
                    {
                        ...
                        Projectile.NewProjectile(Entity.GetSource_FromThis(), (float)num414, (float)num415, 0f, 5f, ModContent.ProjectileType<Whiterain>(), Projectile.damage, 0f, Projectile.owner, 0f, 0f);
                    }
                }
            }
