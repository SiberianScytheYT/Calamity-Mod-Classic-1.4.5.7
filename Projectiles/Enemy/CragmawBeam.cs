...
namespace CalRD.Projectiles.Enemy
{
    public class CragmawBeam : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D laserTailTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/CragmawMireBeamBegin").Value;
            Texture2D laserBodyTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/CragmawMireBeamMid").Value;
            Texture2D laserHeadTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/CragmawMireBeamEnd").Value;
