    ...
    public class StormMarkHostile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.localAI[1] == 60f && Projectile.owner == Main.myPlayer)
            {
                ...
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<TornadoHostile>(), num1137, 3f, Projectile.owner, 0f, 0f);
            }
