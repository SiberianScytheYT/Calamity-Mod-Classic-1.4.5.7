        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                if (Main.netMode != NetmodeID.MultiplayerClient)
                {
                    ...
                    Projectile.NewProjectileDirect(Entity.GetSource_FromThis(), Projectile.Center, angle.ToRotationVector2().RotatedByRandom(0.1f) * 8f, ModContent.ProjectileType<GammaAcid>(),
