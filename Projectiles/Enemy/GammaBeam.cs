...
namespace CalRD.Projectiles.Enemy
{
    ...
    {
        public override string Texture => "CalRD/Projectiles/Enemy/CragmawBeam";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D laserTailTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/GammaBeamBegin").Value;
            Texture2D laserBodyTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/GammaBeamMid").Value;
            Texture2D laserHeadTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/GammaBeamEnd").Value;
