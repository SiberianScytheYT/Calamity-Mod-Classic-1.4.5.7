    ...
    public class IceBlock : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i< 8; i++)
            {
                ...
                Projectile.NewProjectile(Entity.GetSource_FromThis(), projpos, projdir, ModContent.ProjectileType<IceBlockIcicle>(), (int)(Projectile.damage * 0.2f), 4f, Projectile.owner, Main.rand.Next(0, 2), 0f);
            }
        }
    }
}
