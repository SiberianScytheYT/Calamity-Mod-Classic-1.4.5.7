        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                ...
                for (int num119 = 0; num119 < num118; num119 = num3 + 1)
                {
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.oldPosition.X + (float)(Projectile.width / 2), Projectile.oldPosition.Y + (float)(Projectile.height / 2), vector8.X, vector8.Y, ModContent.ProjectileType<GhastlyExplosionShard>(), (int)((double)Projectile.damage * 0.9), Projectile.knockBack * 0.8f, Projectile.owner, Projectile.ai[0], 0f);
                    num3 = num119;
                }
            }
        }
