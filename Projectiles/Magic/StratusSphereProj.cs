	...
	public class StratusSphereProj : ModProjectile
	{
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                {
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Projectile.DirectionTo(targetDir) * 12f, ModContent.ProjectileType<Crescent>(), Projectile.damage / 2, 0.4f, Projectile.owner, Projectile.whoAmI);
                }
