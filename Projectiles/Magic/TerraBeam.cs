    ...
    public class TerraBeam : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.localAI[1] >= 21f && Projectile.owner == Main.myPlayer)
            {
                ...
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<TerraOrb>(), (int)(Projectile.damage * 0.7), Projectile.knockBack, Projectile.owner, 0f, 0f);
            }
