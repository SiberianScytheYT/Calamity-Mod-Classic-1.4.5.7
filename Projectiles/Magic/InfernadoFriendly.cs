    ...
    public class InfernadoFriendly : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] == 1f && Projectile.ai[1] > 0f && Projectile.owner == Main.myPlayer)
            {
                ...
                center.Y += 2f;
				Projectile segment = Projectile.NewProjectileDirect(Entity.GetSource_FromThis(), center, Projectile.velocity, Projectile.type, Projectile.damage, Projectile.knockBack, Projectile.owner, 10f, Projectile.ai[1] - 1f);
				//Defaults to magic
