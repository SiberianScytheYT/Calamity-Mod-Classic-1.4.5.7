    ...
    public class InfernadoMarkFriendly : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                int num236 = Projectile.NewProjectile(Entity.GetSource_FromThis(), (float)(num232 * 16 + 8), (float)(num231 * 16 - 24), 0f, 0f, ModContent.ProjectileType<InfernadoFriendly>(), Projectile.damage, Projectile.knockBack * 30f, Main.myPlayer, 16f, 16f);
