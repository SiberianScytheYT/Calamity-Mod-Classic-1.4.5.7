...
namespace CalRD.Projectiles.Magic
{
    public class LightBlade : ModProjectile
	{
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (calPlayer.danceOfLightCharge >= Judgement.HitsPerFlash)
            {
                ...
                if (Projectile.owner == Main.myPlayer)
                {
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<BlindingLight>(), flashDamage, 0f, Projectile.owner);
                }
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(tex, drawPos, new Rectangle?(rect), mainSwordColor, Projectile.rotation, halfSpriteSize, Projectile.scale, sfx, 0f);
            ...
            for (int i = 0; i < NumAfterimages; ++i)
            {
                ...
                Main.spriteBatch.Draw(tex, imageDrawPos, new Rectangle?(rect), afterimageLight, rotation, halfSpriteSize, afterimageScale, afterimageSfx, 0f);
            }
