...
namespace CalRD.Projectiles.Magic
{
    public class BlushieStaffProj : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/BlushieStaffAura").Value;
            ...
            texture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/BlushieStaffGear").Value;
            ...
            texture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/BlushieStaffFire").Value;
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/BlushieStaffChain").Value;
