...
namespace CalRD.Projectiles.Magic
{
    public class ThunderstormShot : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int n = 0; n < 5; n++)
            {
				CalamityUtils.ProjectileRain(Projectile.GetSource_FromThis(), Projectile.Center, 200f, 100f, 1500f, 1500f, 29f, ModContent.ProjectileType<ThunderstormShotSplit>(), Projectile.damage, Projectile.knockBack, Projectile.owner, Projectile.owner);
            }
