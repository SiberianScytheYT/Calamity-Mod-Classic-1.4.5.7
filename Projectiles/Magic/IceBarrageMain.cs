        ...
        public override void AI()
        {
            ...
            else if (Projectile.ai[0] == 140f)
            {
                ...
                for (int k = 0; k < 45; k++)
                {
                    ...
                    int ice = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, projspeed, ProjectileID.NorthPoleSnowflake, (int)(Projectile.damage * 0.05f), 2f, Projectile.owner, 0f, (float)Main.rand.Next(3));
                ...
                int block1 = Projectile.NewProjectile(Entity.GetSource_FromThis(), pos1, Vector2.Zero, ModContent.ProjectileType<IceBlock>(), (int)(Projectile.damage * 0.3f), 5f, Projectile.owner, 0f, 0f);
                ...
                int block2 = Projectile.NewProjectile(Entity.GetSource_FromThis(), pos2, Vector2.Zero, ModContent.ProjectileType<IceBlock>(), (int)(Projectile.damage * 0.3f), 5f, Projectile.owner, 1f, 0f);
                ...
                int block3 = Projectile.NewProjectile(Entity.GetSource_FromThis(), pos3, Vector2.Zero, ModContent.ProjectileType<IceBlock>(), (int)(Projectile.damage * 0.3f), 5f, Projectile.owner, 2f, 0f);
                ...
                int block4 = Projectile.NewProjectile(Entity.GetSource_FromThis(), pos4, Vector2.Zero, ModContent.ProjectileType<IceBlock>(), (int)(Projectile.damage * 0.3f), 5f, Projectile.owner, 3f, 0f);
