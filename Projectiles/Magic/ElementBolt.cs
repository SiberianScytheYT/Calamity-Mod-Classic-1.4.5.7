    ...
    public class ElementBolt : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.localAI[1] >= 29f && Projectile.owner == Main.myPlayer)
            {
                ...
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<ElementOrb2>(), (int)(Projectile.damage * 0.7f), Projectile.knockBack, Projectile.owner, 0f, 0f);
            }
