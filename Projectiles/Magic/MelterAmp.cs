    ...
    public class MelterAmp : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (flag64)
            {
                ...
                if (!player.ActiveItem().CountsAsClass(DamageClass.Magic) || player.ActiveItem().shoot != ModContent.ProjectileType<MelterNote1>())
                {
                    Projectile.active = false;
                    return;
                }
            ...
            if (Main.myPlayer == Projectile.owner && Projectile.ai[0] == 0f)
            {
                ...
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, VelocityX, VelocityY, type, Damage, Projectile.knockBack, Projectile.owner, 0.0f, 0.0f);
            }
