...
namespace CalRD.Projectiles.Magic
{
    public class InfernalBlade : ModProjectile
    {
		...
		private void OnHitEffects(Vector2 targetPos)
		{
			...
			{
				CalamityUtils.ProjectileBarrage(Projectile.GetSource_FromThis(), Projectile.Center, targetPos, Main.rand.NextBool(), 800f, 800f, 0f, 800f, 10f, ModContent.ProjectileType<InfernalBlade2>(), (int)(Projectile.damage * 0.75), 1f, Projectile.owner, true);
			}
        }
    }
}
