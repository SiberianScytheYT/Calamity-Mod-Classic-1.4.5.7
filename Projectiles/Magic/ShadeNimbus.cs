            ...
            else
            {
                ...
                if (Projectile.ai[0] > 8f)
                {
                    ...
                    if (Projectile.owner == Main.myPlayer)
                    {
                        ...
                        Projectile.NewProjectile(Entity.GetSource_FromThis(), (float)num414, (float)num415, 0f, 5f, ModContent.ProjectileType<Shaderain>(), Projectile.damage, 0f, Projectile.owner, 0f, 0f);
                    }
                }
            }
