...
namespace CalRD.Projectiles.Magic
{
    ...
    {
        public override string Texture => "CalRD/Projectiles/Boss/AstralFlame";
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, i.ToRotationVector2() * 9f, ModContent.ProjectileType<AstralCrystalInvisibleExplosion>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
            }
        }
