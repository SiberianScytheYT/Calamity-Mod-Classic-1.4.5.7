...
namespace CalRD.Projectiles.Magic
{
    public class BrimstoneHellfireballFriendly : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                int fire = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<HellfireExplosionFriendly>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
            }
        }
