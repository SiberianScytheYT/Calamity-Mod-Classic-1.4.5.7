        ...
        public override void AI()
        {
            ...
            else if (num1013 == 1)
            {
                ...
                if (Projectile.ai[0] % 30f == 0f && Projectile.ai[0] < 241f && Main.myPlayer == Projectile.owner)
                {
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, vector144.X, vector144.Y, ModContent.ProjectileType<GhastlySubBlast>(), Projectile.damage, 0f, Projectile.owner, 0f, (float)Projectile.whoAmI);
                }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                ...
                for (int num110 = 0; num110 < num106; num110++)
                {
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), vector4.X, vector4.Y, vector5.X, vector5.Y, ModContent.ProjectileType<GhastlyExplosionShard>(), (int)((double)Projectile.damage * 0.8), Projectile.knockBack * 0.8f, Projectile.owner, (float)num108, 0f);
                }
                for (int num111 = 0; num111 < num107; num111++)
                {
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), vector6.X, vector6.Y, vector7.X, vector7.Y, ModContent.ProjectileType<GhastlyExplosion>(), (int)((double)Projectile.damage * 0.8), Projectile.knockBack * 0.8f, Projectile.owner, (float)num109, 0f);
                }
            }
        }
    }
