...
namespace CalRD.Projectiles.Magic
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Magic/ValkyrieRay";
        ...
        public override void AI()
        {
            ...
            if (chargeLevel >= 1f && Projectile.ai[1] == 0f)
            {
                ...
                {
                    Projectile laser = Projectile.NewProjectileDirect(Entity.GetSource_FromThis(), gemPos, Projectile.velocity, ModContent.ProjectileType<ValkyrieRayBeam>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
                    laser.Center = gemPos;
                }
            }
