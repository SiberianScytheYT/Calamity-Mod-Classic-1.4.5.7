...
namespace CalRD.Projectiles.Magic
{
    public class AsteroidMolten : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                int num340 = Gore.NewGore(Entity.GetSource_FromThis(), Projectile.position + new Vector2((float)(Projectile.width * Main.rand.Next(100)) / 100f, (float)(Projectile.height * Main.rand.Next(100)) / 100f) - Vector2.One * 10f, default, Main.rand.Next(61, 64), 1f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            switch ((int)Projectile.ai[0])
            {
                case 0:
                    break;
                case 1:
                    texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Magic/AsteroidMolten2").Value;
                    break;
                case 2:
                    texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Magic/AsteroidMolten3").Value;
                    break;
                case 3:
                    texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Magic/AsteroidMolten4").Value;
                    break;
                case 4:
                    texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Magic/AsteroidMolten5").Value;
                    break;
                case 5:
                    texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Magic/AsteroidMolten6").Value;
                    break;
                default:
                    break;
            }
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Magic/AsteroidMoltenGlow").Value;
            switch ((int)Projectile.ai[0])
            {
                case 0:
                    break;
                case 1:
                    texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Magic/AsteroidMoltenGlow2").Value;
                    break;
                case 2:
                    texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Magic/AsteroidMoltenGlow3").Value;
                    break;
                case 3:
                    texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Magic/AsteroidMoltenGlow4").Value;
                    break;
                case 4:
                    return;
                case 5:
                    texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Magic/AsteroidMoltenGlow6").Value;
                    break;
                default:
                    break;
            }
