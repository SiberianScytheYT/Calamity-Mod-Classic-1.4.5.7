            ...
            if (Projectile.ai[0] == 0f)
            {
                ...
                if (Projectile.alpha <= 0)
                {
                    ...
                    if (Main.myPlayer == Projectile.owner)
                    {
                        ...
                        int number = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.position.X + Projectile.velocity.X + (float)(Projectile.width / 2), Projectile.position.Y + Projectile.velocity.Y + (float)(Projectile.height / 2),
