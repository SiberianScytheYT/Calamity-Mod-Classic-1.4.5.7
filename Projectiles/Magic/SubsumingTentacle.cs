    ...
    public class SubsumingTentacle : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (Projectile.scale < 1f)
            {
                ...
                {
                    var tentacleShader = GameShaders.Misc["CalRD:SubsumingTentacle"];
                    ...
                    Main.spriteBatch.Draw(ModContent.Request<Texture2D>(Texture).Value, drawPos, null, color, Projectile.rotation, ModContent.Request<Texture2D>(Texture).Size() / 2f, scale, SpriteEffects.None, 0f);
