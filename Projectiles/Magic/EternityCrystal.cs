...
namespace CalRD.Projectiles.Magic
{
    public class EternityCrystal : ModProjectile
    {
        ...
        public void ExplosionEffect(NPC target, Player player)
        {
            ...
            SoundEngine.PlaySound(new SoundStyle("CalRD/Sounds/Item/LargeWeaponFire"), target.Center);
            Projectile.Kill();
        }
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (float i = 0f; i < 5; i++)
            {
                ...
                Main.EntitySpriteDraw(myTexture, drawPosition, frame, trasparentCrystalColor, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0f);
            }
            return true;
        }
    }
