...
namespace CalRD.Projectiles.Magic
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Magic/Purge";
                ...
                if (flag && Main.myPlayer == Projectile.owner)
                {
                    ...
                    if (flag2)
                    {
                        ...
                        for (int j = 0; j < 3; j++)
                        {
                            ...
                            Projectile.NewProjectile(Entity.GetSource_FromThis(), value2.X, value2.Y, spinningpoint.X, spinningpoint.Y, num6, weaponDamage2, Projectile.knockBack, Projectile.owner, 0f, 0f);
                        }
                    }
                    else
                    {
