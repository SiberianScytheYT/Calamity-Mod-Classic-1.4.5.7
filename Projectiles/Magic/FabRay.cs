...
namespace CalRD.Projectiles.Magic
{
    public class FabRay : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<FabOrb>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
            }
