        ...
        public override void AI()
        {
            ...
            if (!initialized)
            {
                ...
                for (int dustIndex = 0; dustIndex < dustAmt; dustIndex++)
                {
                    ...
                    int dusty = Dust.NewDust(vector6 + vector7, 0, 0, DustID.Torch, vector7.X * 1f, vector7.Y * 1f, 100, default, 1.1f);
			...
			targetVec.Normalize();
			targetVec *= speedMult;
			int spike = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, targetVec, ModContent.ProjectileType<CausticStaffProjectile>(), Projectile.damage, Projectile.knockBack, Projectile.owner, debuffToInflict, 0f);
			debuffToInflict++;
