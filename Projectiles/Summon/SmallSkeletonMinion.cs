    ...
    public class SmallSkeletonMinion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] % 60f == 59f && Main.myPlayer == Projectile.owner)
            {
                ...
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Vector2.Zero, type, Projectile.damage, Projectile.knockBack, Projectile.owner);
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(ModContent.Request<Texture2D>(Texture).Value, Projectile.Center - Main.screenPosition, frame, Color.White, Projectile.rotation, Projectile.Size / 2f, 1f, spriteEffects, 0f);
            return false;
        }
