            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                if (flag11)
                {
                    ...
                    for (int b = 0; b < blastAmt; b++)
                    {
                        ...
                        Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, velocity, ModContent.ProjectileType<CosmicBlast>(), (int)(Projectile.damage * 0.5), 2f, Projectile.owner, (float)target, 0f);
                    }
                    float speed = 15f;
                    ...
                    num404 *= num406;
                    num405 *= num406;
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, num404, num405, ModContent.ProjectileType<CosmicBlastBig>(), Projectile.damage, 3f, Projectile.owner, (float)target, 0f);
                    Projectile.ai[0] = 100f;
                }
            }
        }
