                        ...
                        if (!Collision.SolidCollision(center, num3, num3))
                        {
                                ...
                                Collision.CanHit(new Vector2(Projectile.Center.X, Projectile.position.Y - 50f), 1, 1, center, 1, 1))
                            {
                                ...
                                if (flag)
                                {
                                    ...
                                    {
                                        Projectile.NewProjectile(Entity.GetSource_FromThis(), center.X, center.Y, 0f, 0f, ModContent.ProjectileType<Dreadmine>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
                                    }
                                }
                            }
                        }
