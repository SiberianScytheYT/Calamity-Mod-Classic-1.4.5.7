...
namespace CalRD.Projectiles.Summon
{
    ...
    {
        public override string Texture => "CalRD/NPCs/Polterghast/PhantomFuckYou";
            ...
            if (Projectile.ai[0] == 0f)
            {
                ...
                if (flag25 && Projectile.ai[1] == 0f)
                {
                    ...
                    if (Main.myPlayer == Projectile.owner)
                    {
                        ...
                        Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, value19.X, value19.Y, num658, Projectile.damage, 0f, Main.myPlayer, 0f, 0f);
                        Projectile.netUpdate = true;
                    }
                }
            }
