...
namespace CalRD.Projectiles.Summon
{
    public class EndoBeam : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            //Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, directionVector, ModContent.ProjectileType<Beam>(), damage, 0f, Main.myPlayer, angularChange, (float)projectile.whoAmI);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D laserTailTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/LaserBegin").Value;
            Texture2D laserBodyTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/LaserMid").Value;
            Texture2D laserHeadTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/LaserEnd").Value;
        ...
        {
            target.AddBuff(ModLoader.GetMod("CalRD").Find<ModBuff>("GodSlayerInferno").Type, 300);
        }
    }
}
