...
namespace CalRD.Projectiles.Summon
{
    public class MidnightSunBeam : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D laserTailTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/MidnightSunBeamBegin").Value;
            Texture2D laserBodyTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/MidnightSunBeamMid").Value;
            Texture2D laserHeadTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/MidnightSunBeamEnd").Value;
