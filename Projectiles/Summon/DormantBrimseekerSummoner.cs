...
namespace CalRD.Projectiles.Summon
{
    public class DormantBrimseekerSummoner : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Vector2.UnitY * 7f, ModContent.ProjectileType<DormantBrimseekerBab>(), Projectile.damage, Projectile.knockBack,
                    Projectile.owner);
                Projectile.Kill();
            }
		}
