        ...
        public override void AI()
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                if (foundTarget)
                {
					...
					velocity.Normalize();
					velocity *= shootSpeed;
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), source, velocity, ModContent.ProjectileType<SolarBeam>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
                    Projectile.ai[0] = 30f;
                }
            }
        }
