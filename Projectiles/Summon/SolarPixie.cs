        ...
        public override void AI()
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                if (foundTarget)
                {
					...
					velocity.Normalize();
					velocity *= shootSpeed;
                    int beam = Projectile.NewProjectile(Entity.GetSource_FromThis(), source, velocity, ProjectileID.HeatRay, Projectile.damage, Projectile.knockBack, Projectile.owner);
