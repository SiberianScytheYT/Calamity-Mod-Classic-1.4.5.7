			...
			if (num < 20)
			{
				...
				if (Projectile.ai[1] >= 75f)
				{
					...
					if (Projectile.owner == Main.myPlayer)
					{
						...
						Projectile.NewProjectile(Entity.GetSource_FromThis(), startPos, speed, ModContent.ProjectileType<LanternFlame>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
					}
				}
            }
        }
