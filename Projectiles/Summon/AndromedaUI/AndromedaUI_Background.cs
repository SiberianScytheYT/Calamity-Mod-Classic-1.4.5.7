...
namespace CalRD.Projectiles.Summon.AndromedaUI
{
	public class AndromedaUI_Background : ModProjectile
    {
        ...
        {
            Texture2D leftBracketTexture = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/AndromedaUI/LeftBracket" + (LeftBracketActive ? "Lit" : "")).Value;
            Texture2D leftBracketTextureHovered = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/AndromedaUI/LeftBracketHovered").Value;

            Texture2D rightBracketTexture = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/AndromedaUI/RightBracket" + (RightBracketActive ? "Lit" : "")).Value;
            Texture2D rightBracketTextureHovered = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/AndromedaUI/RightBracketHovered").Value;

            Texture2D topBracketTexture = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/AndromedaUI/TopBracket" + (BottomBracketActive ? "Lit" : "")).Value;
            Texture2D topBracketTextureHovered = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/AndromedaUI/TopBracketHovered").Value;
        ...
        public void DrawLeftIcon(SpriteBatch spriteBatch)
        {
            ...
            Texture2D smallIndicator = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/AndromedaUI/SmallIcon").Value;
            Texture2D smallIndicatorLocked = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/AndromedaUI/Lock").Value;
        ...
        {
            // Define icons to draw
            Texture2D thunderIndicator = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/AndromedaUI/ThunderIcon").Value;
            Texture2D thunderIndicatorHovered = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/AndromedaUI/ThunderIconHovered").Value;
            Texture2D thunderIndicatorCharge = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/AndromedaUI/ThunderIconCharge").Value;
            Texture2D thunderIndicatorLocked = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/AndromedaUI/Lock").Value;
            ...
            if (textureToDraw != thunderIndicatorLocked && RightIconCooldown <= 0)
            {
                ...
                if (MouseRectangle.Intersects(iconFrame))
                {
                    ...
                    if (Main.mouseLeft && Main.projectile[(int)Projectile.localAI[0]].ai[0] <= 0f)
                    {
                        ...
                        SoundEngine.PlaySound(new SoundStyle("CalRD/Sounds/Item/LargeMechGaussRifle"), Projectile.Center);
                    }
                }
            }
        ...
        {
            // Define icons to draw
            Texture2D meleeIndicator = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/AndromedaUI/MeleeIcon").Value;
            Texture2D rangedIndicator = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/AndromedaUI/RangedIcon").Value;
            Texture2D attackIndicatorLocked = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/AndromedaUI/Lock").Value;
            Texture2D meleeIndicatorHovered = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/AndromedaUI/MeleeIconHovered").Value;
            Texture2D rangedIndicatorHovered = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/AndromedaUI/RangedIconHovered").Value;
        ...
        public override bool? CanDamage()/* tModPorter Suggestion: Return null instead of true */ => false; // This is a UI. It should not do damage.
    }
}
