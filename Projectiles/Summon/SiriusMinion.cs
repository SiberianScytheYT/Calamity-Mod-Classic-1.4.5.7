		...
		public override void AI()
		{
			...
			if (Projectile.owner == Main.myPlayer)
			{
				...
				if (hasTarget)
				{
					...
					int beam = Projectile.NewProjectile(Entity.GetSource_FromThis(), source, velocity, ModContent.ProjectileType<SiriusBeam>(), (int)(Projectile.damage * damageMult), Projectile.knockBack, Projectile.owner);
