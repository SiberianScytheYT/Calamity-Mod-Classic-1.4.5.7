...
namespace CalRD.Projectiles.Summon
{
    ...
    {
        public override string Texture => "CalRD/Items/Weapons/Summon/DormantBrimseeker";
        ...
        public override void AI()
        {
            ...
            if (Math.Abs(Projectile.rotation + MathHelper.PiOver4) < 0.04f)
            {
                ...
                else
                {
                    ...
                    {
                        int idx = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<BrimseekerAuraBall>(), Projectile.damage, 3f, Projectile.owner, Projectile.whoAmI);
