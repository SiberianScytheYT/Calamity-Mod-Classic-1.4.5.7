	...
	public class GastricBelcher : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (Main.myPlayer == Projectile.owner)
			{
				...
				{
					SoundEngine.PlaySound(SoundID.NPCDeath13.WithVolumeScale(0.5f), Projectile.Center);
				...
				Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, vomitVel, projType, Projectile.damage, Projectile.knockBack, Projectile.owner, Main.rand.Next(3), 0f);
				...
				if (bubbleCounter++ % 3 == 2)
				{
					for (int projCount = 0; projCount < 5; projCount++)
					{
						...
						Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, bubbleVel, ModContent.ProjectileType<GastricBelcherBubble>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
					}
				}
