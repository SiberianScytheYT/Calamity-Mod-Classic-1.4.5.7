...
namespace CalRD.Projectiles.Summon
{
    ...
    {
        public override string Texture => "CalRD/Projectiles/Ranged/SandyWaifuShark";
        ...
        {
            SoundEngine.PlaySound(SoundID.Item70.WithVolumeScale(0.5f), Projectile.Center);
            Projectile.velocity = new Vector2(0f, 5f).RotatedBy(Projectile.velocity.ToRotation() + 1.5f);
            int sand = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<SandExplosion>(), (int)(Projectile.damage * 0.7f), (int)(Projectile.knockBack * 0.7f), Projectile.owner, 0f, 0f);
