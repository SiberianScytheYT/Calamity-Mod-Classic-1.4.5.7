...
namespace CalRD.Projectiles.Summon
{
	public class WulfrumDroid : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			velocity.Normalize();
			velocity *= 10f;
			int bolt = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, velocity, ModContent.ProjectileType<WulfrumBoltMinion>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
