...
namespace CalRD.Projectiles.Summon
{
	public class AstralProbeSummon : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			{
				SoundEngine.PlaySound(SoundID.Item12.WithVolumeScale(0.5f), Projectile.position);
				Projectile.ai[1] += 1f;
				if (Main.myPlayer == Projectile.owner)
				{
					...
					velocity.Normalize();
					velocity *= speedMult;
					Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, velocity, projType, Projectile.damage, 0f, Projectile.owner, targetIndex, 0f);
					Projectile.netUpdate = true;
				}
			}
        }
