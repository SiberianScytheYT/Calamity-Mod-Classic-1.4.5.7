...
namespace CalRD.Projectiles.Summon
{
    ...
    {
        public override string Texture => "CalRD/NPCs/Astral/Hive";
        ...
        public override void AI()
        {
            ...
            if (Projectile.owner == Main.myPlayer && flag25)
            {
                ...
                if ((Projectile.ai[1] % 15f) == 0f)
                {
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, velocityX, velocityY, ModContent.ProjectileType<Hiveling>(), Projectile.damage, Projectile.knockBack, Projectile.owner, (float)target, 0f);
                }
            }
        }
