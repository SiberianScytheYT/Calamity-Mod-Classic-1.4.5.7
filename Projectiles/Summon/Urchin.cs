            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                if (foundTarget)
                {
                    ...
                    for (int u = 0; u < projAmt; u++)
                    {
                        ...
                        int spore = Projectile.NewProjectile(Entity.GetSource_FromThis(), source, velocity, ModContent.ProjectileType<UrchinSpike>(), Projectile.damage, 1f, Projectile.owner, 0f, 0f);
