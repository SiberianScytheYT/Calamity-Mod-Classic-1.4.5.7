...
namespace CalRD.Projectiles.Summon
{
	public class EndoCooperLimbs : ModProjectile
    {
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/EndoCooperLimbs_Glow").Value, Projectile.Center - Main.screenPosition, frame, Color.LightSkyBlue, Projectile.rotation, Projectile.Size / 2, 1f, SpriteEffects.None, 0f);
        }
        ...
        private void SpawnShards()
        {
            ...
            if (AttackMode == 1)
            {
                for (int i = 0; i < 360; i += 60)
                {
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, pspeed1, ModContent.ProjectileType<EndoIceShard>(), (int)(Projectile.damage * dmgmult), 1f, Projectile.owner, 0f, 0f);
                    Vector2 pspeed2 = pspeed1.RotatedBy(MathHelper.ToRadians(Main.rand.Next(5, 13))) * Main.rand.NextFloat(0.6f, 1.3f);
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, pspeed2, ModContent.ProjectileType<EndoIceShard>(), (int)(Projectile.damage * dmgmult), 1f, Projectile.owner, 0f, 0f);
                    Vector2 pspeed3 = pspeed1.RotatedBy(MathHelper.ToRadians(Main.rand.Next(-12, -1))) * Main.rand.NextFloat(0.6f, 1.3f);
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, pspeed3, ModContent.ProjectileType<EndoIceShard>(), (int)(Projectile.damage * dmgmult), 1f, Projectile.owner, 0f, 0f);
                }
            }
        }
        ...
        private void SpawnFlames()
        {
            ...
            for (int i = 0; i < 360; i += 60)
            {
                ...
                int flame = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, pspeed1, ModContent.ProjectileType<EndoFire>(), (int)(Projectile.damage * dmgmult), 1f, Projectile.owner, 0f, 0f);
            }
        }
    }
}
