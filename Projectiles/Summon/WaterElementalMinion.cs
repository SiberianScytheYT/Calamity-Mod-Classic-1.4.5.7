        ...
        public override void AI()
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                if (flag18 && Projectile.localAI[0] >= 120f)
                {
                    ...
                    num404 *= num406;
                    num405 *= num406;
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X - 4f, Projectile.Center.Y, num404, num405, projectileType, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
                    Projectile.ai[0] = 12f;
                }
            }
        }
