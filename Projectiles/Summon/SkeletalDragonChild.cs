	...
	public class SkeletalDragonChild : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (target != null)
            {
                ...
                {
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Projectile.DirectionTo(target.Center) * 19f, ModContent.ProjectileType<BloodSpit>(), mother.damage, mother.knockBack, mother.owner);
                }
            }
