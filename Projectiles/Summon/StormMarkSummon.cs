...
namespace CalRD.Projectiles.Summon
{
    public class StormMarkSummon : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int storm = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<Tornado>(), Projectile.damage, 2f, Projectile.owner, 1f, 0f);
