...
namespace CalRD.Projectiles.Summon
{
    public class Cinder : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int idx = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Torch, 0f, 0f, 100, default, 1f);
            ...
            {
                idx = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Torch, 0f, 0f, 100, default, 1f);
                Main.dust[idx].position += new Vector2(2f);
