	...
	public class BlackHawkSummon : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (Main.myPlayer == Projectile.owner)
			{
				...
				velocity.Normalize();
				velocity *= projSpeed;
				Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, velocity, projType, Projectile.damage, Projectile.knockBack, Projectile.owner);
				Projectile.netUpdate = true;
			}
		}
		...
		{
			Texture2D texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/BlackHawkGlow").Value;
			int frameHeight = texture.Height / Main.projFrames[Projectile.type];
			int y6 = frameHeight * Projectile.frame;
			SpriteEffects spriteEffects = SpriteEffects.None;
			if (Projectile.spriteDirection == -1)
