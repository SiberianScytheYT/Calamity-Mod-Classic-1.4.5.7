	...
	public class MagicRifle : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (Main.myPlayer == Projectile.owner)
			{
				...
				{
					SoundEngine.PlaySound(SoundID.Item20.WithVolumeScale(0.1f), Projectile.position);
				}
				Projectile.ai[1] += 1f;
				if (Main.myPlayer == Projectile.owner)
				{
					...
					Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, velocity, projType, Projectile.damage, 0f, Projectile.owner);
					Projectile.netUpdate = true;
				}
			}
		}
