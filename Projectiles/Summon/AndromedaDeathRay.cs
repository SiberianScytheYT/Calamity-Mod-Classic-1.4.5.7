...
namespace CalRD.Projectiles.Summon
{
    public class AndromedaDeathRay : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D laserTailTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/AndromedaDeathrayBegin").Value;
            Texture2D laserBodyTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/AndromedaDeathrayMid").Value;
            Texture2D laserHeadTexture = ModContent.Request<Texture2D>("CalRD/ExtraTextures/Lasers/AndromedaDeathrayEnd").Value;
