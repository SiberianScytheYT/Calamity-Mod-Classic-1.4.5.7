...
namespace CalRD.Projectiles.Summon
{
	public class HowlsHeartHowl : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			int fireball = Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, targetVec, ModContent.ProjectileType<HowlsHeartFireball>(), Projectile.damage, Projectile.knockBack, Projectile.owner, targetIndex, 0f);
