...
namespace CalRD.Projectiles.Summon
{
	public class EndoCooperBody : ModProjectile
    {
                    ...
                    if (Main.myPlayer == Projectile.owner)
                    {
                        switch (AttackMode)
                        {
                            case 0:
                                    ...
                                    //aimlaser *= 12f;
                                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center, aimlaser, ModContent.ProjectileType<EndoBeam>(), Projectile.damage, 0f, Projectile.owner, angularChange, (float)Projectile.whoAmI);
                                    laserdirection *= -1;
                                    break;
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/EndoCooperBody_Glow").Value, Projectile.Center - Main.screenPosition, frame, Color.LightSkyBlue, Projectile.rotation, Projectile.Size / 2, 1f, SpriteEffects.None, 0f);
        }
