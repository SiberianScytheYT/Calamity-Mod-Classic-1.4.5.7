    ...
    public class PlantSporeCloud : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
			...
			if (Projectile.ai[0] == 1f)
				tex = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/PlantSporeCloud2").Value;
			if (Projectile.ai[0] == 2f)
				tex = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/PlantSporeCloud3").Value;
