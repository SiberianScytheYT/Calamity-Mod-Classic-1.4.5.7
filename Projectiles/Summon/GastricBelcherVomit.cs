...
namespace CalRD.Projectiles.Summon
{
	public class GastricBelcherVomit : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			{
				case 1f: texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/GastricBelcherVomit2").Value;
						 break;
				case 2f: texture = ModContent.Request<Texture2D>("CalRD/Projectiles/Summon/GastricBelcherVomit3").Value;
						 break;
