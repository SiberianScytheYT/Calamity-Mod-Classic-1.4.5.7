                ...
                if (flag)
                {
                    ...
                    if ((vector - Projectile.Center).Length() <= 600f && Projectile.ai[1] == 0f)
                    {
                        ...
                        if (Main.myPlayer == Projectile.owner)
                        {
                            ...
                            Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y + 20, vector7.X, vector7.Y, num28, Projectile.damage, 0f, Main.myPlayer, targetIndex, 0f);
                            Projectile.netUpdate = true;
                        }
                    }
                }
