...
namespace CalRD.Projectiles.Summon
{
    ...
    {
        public override string Texture => "CalRD/NPCs/NormalNPCs/ImpiousImmolator";
        ...
        public override void AI()
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                if (flag18)
                {
                    ...
                    num404 *= num406;
                    num405 *= num406;
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, num404, num405, projectileType, Projectile.damage, Projectile.knockBack, Projectile.owner, (float)target, 0f);
                    Projectile.ai[0] = 16f;
                }
            }
        }
