        ...
        public void FirePetals(NPC target)
        {
            if (PetalFireTimer % 20f == 19f)
            {
                for (int i = -1; i <= 1; i++)
                {
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center + new Vector2(0f, -6f),
            ...
            if (PetalFireTimer % 180f == 179f)
            {
                for (int i = 0; i < 5; i++)
                {
                    ...
                    Projectile.NewProjectile(Entity.GetSource_FromThis(), Projectile.Center + Vector2.UnitY * -6f,
