...
namespace CalRD.World
{
    public class SunkenSea : ModSystem
    {
            ...
            Generates sea prism crystals on prism ore and occasionally on navystone*/
        {
            ...
            /*
            Point point = new Point(GenVars.UndergroundDesertLocation.Left + (GenVars.UndergroundDesertLocation.Width / 2),
                GenVars.UndergroundDesertLocation.Bottom + (GenVars.UndergroundDesertLocation.Height / 3)); //Around the center of the Sunken Sea area
            */
            ...
            //int sunkenSeaBottom = GenVars.UndergroundDesertLocation.Bottom + (int)((double)GenVars.UndergroundDesertLocation.Height * 0.7);
			int smallHoles = 0;
            ...
            for (int i = -20; i < num + 20; i++)
            {
                for (int j = -20; j < num2 + 20; j++)
                {
                    ...
                    {
                        genCentalHole = false;
                        rectangle = new Rectangle(GenVars.UndergroundDesertLocation.Left + (GenVars.UndergroundDesertLocation.Width / 2) - radius,
                            GenVars.UndergroundDesertLocation.Bottom + (GenVars.UndergroundDesertLocation.Height / 3) - radius, diameter, diameter);
                    ...
                    /*
                    point = new Point(WorldGen.genRand.Next(GenVars.UndergroundDesertLocation.Left + 30, GenVars.UndergroundDesertLocation.Right - 30),
                        WorldGen.genRand.Next(GenVars.UndergroundDesertLocation.Bottom + 20, sunkenSeaBottom));
                        */
