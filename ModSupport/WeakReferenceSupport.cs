	...
	internal class WeakReferenceSupport
	{
		...
		private static void AddCalamityBosses(Mod bossChecklist, Mod calamity)
		{
			// Desert Scourge
			{
				...
				string bossLogTex = "CalRD/NPCs/DesertScourge/DesertScourge_BossChecklist";
			...
			// Cryogen
			{
				...
				string bossLogTex = "CalRD/NPCs/Cryogen/Cryogen_BossChecklist";
			...
			// Aquatic Scourge
			{
				...
				string bossLogTex = "CalRD/NPCs/AquaticScourge/AquaticScourge_BossChecklist";
			...
			// Siren and Leviathan
			{
				...
				string bossLogTex = "CalRD/NPCs/Leviathan/SirenandLevi_BossChecklist";
			...
			// Plaguebringer Goliath
			{
				...
				string bossLogTex = "CalRD/NPCs/PlaguebringerGoliath/PlaguebringerGoliath_BossChecklist";
			...
			// Ravager
			{
				...
				string bossLogTex = "CalRD/NPCs/Ravager/Ravager_BossChecklist";
			...
			// Astrum Deus
			{
				...
				string bossLogTex = "CalRD/NPCs/AstrumDeus/AstrumDeus_BossChecklist";
			...
			// Profaned Guardians
			{
				...
				string bossLogTex = "CalRD/NPCs/ProfanedGuardians/ProfanedGuardians_BossChecklist";
			...
			// Providence
			{
				...
				string bossLogTex = "CalRD/NPCs/Providence/Providence_BossChecklist";
			...
			// Storm Weaver
			{
				...
				string bossLogTex = "CalRD/NPCs/StormWeaver/StormWeaver_BossChecklist";
			...
			// Devourer of Gods
			{
				...
				string bossLogTex = "CalRD/NPCs/DevourerofGods/DevourerofGods_BossChecklist";
			...
			// Yharon
			{
				...
				string bossLogTex = "CalRD/NPCs/Yharon/Yharon_BossChecklist";
		...
		private static void AddCalamityInvasions(Mod bossChecklist, Mod calamity)
		{
			...
			// Post-Aquatic Scourge Acid Rain
			{
				...
				string bossLogTex = "CalRD/Events/AcidRainT2_BossChecklist";
				string iconTexture = "CalRD/ExtraTextures/UI/AcidRainIcon";
			...
			// Post-Polterghast Acid Rain
			{
				...
				string despawn = CalamityUtils.ColorMessage("The mysterious creatures of the sulphuric sea descended back into the deep ocean.", new Color(146, 183, 116));
				string bossLogTex = "CalRD/Events/AcidRainT3_BossChecklist";
				string iconTexture = "CalRD/ExtraTextures/UI/AcidRainIcon";
