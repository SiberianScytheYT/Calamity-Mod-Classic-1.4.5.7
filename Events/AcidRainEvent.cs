...
namespace CalRD.Events
{
    ...
    public class AcidRainEvent
    {
        ...
        public static void TryStartEvent(bool forceRain = false)
        {
            ...
            UpdateInvasion();
            BroadcastEventText("A toxic downpour falls over the wasteland seas!"); // A toxic downpour falls over the wasteland seas!
        }
        /// <summary>
        ...
        public static void UpdateInvasion(bool win = true)
        {
            ...
            if (CalamityWorld.rainingAcid)
            {
                ...
                if (CalamityWorld.acidRainPoints <= 0)
                {
                    ...
                    BroadcastEventText("The sulphuric skies begin to clear..."); // The sulphuric skies begin to clear...
                ...
                if (Main.netMode == NetmodeID.Server)
                {
                    ...
                    netMessage.Write((byte)CalRDMessageType.AcidRainSync);
                ...
                {
                    var netMessage = CalRD.Instance.GetPacket();
                    netMessage.Write((byte)CalRDMessageType.AcidRainUIDrawFadeSync);
                ...
                {
                    var netMessage = CalRD.Instance.GetPacket();
                    netMessage.Write((byte)CalRDMessageType.AcidRainOldDukeSummonSync);
				...
				{
					var netMessage = CalRD.Instance.GetPacket();
					netMessage.Write((byte)CalRDMessageType.EncounteredOldDukeSync);
